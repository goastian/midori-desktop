...
# ═══════════════════════════════════════════════════════════════
# macOS setup
# macOS builds run natively on GitHub-hosted macOS runners.
# No cross-compilation toolchain is required from Linux.
# ═══════════════════════════════════════════════════════════════
setup_macos() {
  echo ""
  echo "══════════════════════════════════════════"
  ...
  echo "→ Dependencias del sistema (macOS):"
  ...
  echo "══════════════════════════════════════════"
  echo "  Rust x86_64: $(rustup target list --installed 2>/dev/null | grep x86_64-apple-darwin || echo 'no instalado')"
  echo "  Rust aarch64: $(rustup target list --installed 2>/dev/null | grep aarch64-apple-darwin || echo 'no instalado')"
  echo ""
  echo "Usa: npm run build:mac-x64  o  npm run build:mac-arm64  para compilar."
}
