    ...
    return (
      <div className={prefs["floorp.newtab.backdrop.blur.disable"] ? "" : "floorp-backdrop-blur-enable"}>
        ...
        <div id="floorp">
          ...
          <a className={prefs["floorp.newtab.releasenote.hide"] ? "floorp-releasenote-hidden" : "releasenote"} data-l10n-id="aboutdialog-help-user" href="https://help.astian.org"></a><br /><br />
          <a className={prefs["floorp.newtab.releasenote.hide"] ? "floorp-releasenote-hidden" : "releasenote"} data-l10n-id="releaseNotes-link" href="https://astian.org/midori-en"></a>
        </div>
