...
const AUTO_UBLOCK_DIR = path.join(os.tmpdir(), "midori-blocker-ublock");
...
/**
 * Wrap scriptlet functions to consume Midori placeholder args.
 *
...
/**
 * Build Midori scriptlet resources from uBO built-in scriptlets.
 *
