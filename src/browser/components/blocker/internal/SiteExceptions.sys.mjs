...
import { toSafeDomain } from "resource:///modules/MidoriBlockerUtils.sys.mjs";
...
export const PERMISSION_TYPE = "midori-blocker";
export const PERMISSION_TYPE_PB = "midori-blocker-pb";
...
/**
 * Stores blocker site exceptions as midori-blocker permissions. Permanent
