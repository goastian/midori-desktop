...
import { isPrivateBrowsingContext } from "resource:///modules/MidoriBlockerUtils.sys.mjs";
 ...
 */
export class MidoriBlockedPageParent extends JSWindowActorParent {
  receiveMessage(message) {
    if (message.name !== "MidoriBlockedPage:AllowAndNavigate") {
      return undefined;
    }
