...
export class CustomizableUIWrapper {
  ...
  static registerArea(
    ...
    window.CustomizableUI.registerArea(id, {
      type,
      defaultCollapsed,
      overflowable,
      defaultPlacements,
  ...
  static registerToolbarNode(node) {
    window.CustomizableUI.registerToolbarNode(node);
  }
  ...
  static createWidget({
    ...
    return window.CustomizableUI.createWidget({
      id,
      type,
      localized,
      onCreated,
   ...
   */
  static getWidget(id) {
    return window.CustomizableUI.getWidget(id);
  }
  ...
  static destroyWidget(id) {
    window.CustomizableUI.destroyWidget(id);
  }
  ...
  static addWidgetToArea(id, area, position) {
    window.CustomizableUI.addWidgetToArea(id, area, position);
  }
  ...
  static getPlacementOfWidget(id) {
    return window.CustomizableUI.getPlacementOfWidget(id);
  }
}
