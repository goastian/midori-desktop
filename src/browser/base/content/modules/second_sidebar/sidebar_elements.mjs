...
export class SidebarElements {
  ...
  static #createPopups() {
    ...
    const mainPopupSet = new XULElement({
      element: window.document.getElementById("mainPopupSet"),
    });
  ...
  static #createContextMenuItems() {
    ...
    const separator = new XULElement({
      element: window.document.getElementById("context-sep-open"),
    });
    const contextSearchSelect = new XULElement({
      element: window.document.getElementById("context-searchselect"),
    });
