...
export class SidebarMainCollapser {
  ...
  handleEvent(event) {
    ...
    if (
      (!window.fullScreen &&
        (!SidebarControllers.sidebarController || !SidebarControllers.sidebarController.autoHideSidebar)) ||
  ...
  collapse({
    ...
    window.clearTimeout(this.showSidebarTimer);
    this.showSidebarTimer = null;
    if (!this.hideSidebarTimer) {
      this.hideSidebarTimer = window.setTimeout(() => {
  ...
  uncollapse({
    ...
    window.clearTimeout(this.hideSidebarTimer);
    this.hideSidebarTimer = null;
    if (!this.showSidebarTimer) {
      this.showSidebarTimer = window.setTimeout(() => {
        this.shouldAnimate(animate);
        this.fullScreenShouldAnimate(fullScreenAnimate);
