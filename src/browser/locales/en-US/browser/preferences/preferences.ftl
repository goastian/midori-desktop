...
performance-memory-profile-title = Memory Optimization
performance-memory-profile-label = Memory usage profile
performance-memory-profile-desc = Choose how { -brand-short-name } manages memory. Lower memory profiles reduce RAM usage but may affect performance.
performance-memory-profile-performance =
    .label = Performance (Higher RAM, faster)
performance-memory-profile-balanced =
    .label = Balanced (Recommended)
performance-memory-profile-lowmemory =
    .label = Low Memory (Lower RAM, slower)
