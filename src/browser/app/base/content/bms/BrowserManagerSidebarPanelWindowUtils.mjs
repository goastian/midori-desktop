...
import { BrowserManagerSidebar } from "chrome://midori/content/modules/bms/BrowserManagerSidebar.mjs";
...
export const BrowserManagerSidebarPanelWindowUtils = {
  ...
  get BROWSER_SIDEBAR_DATA() {
    return JSON.parse(
      Services.prefs.getStringPref("midori.browser.sidebar2.data", undefined)
    );
  },
