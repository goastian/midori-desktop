...
pref('midori.modblur.windowControls.style', 'system');
pref('midori.modblur.bookmarks.popout', false);
pref('midori.modblur.bookmarks.clean', true);
pref('midori.modblur.bookmarks.hideFolderIcons', false);
pref('midori.modblur.bookmarks.transparent', false);
pref('midori.modblur.bookmarks.centered', false);
pref('midori.modblur.privacy.blurIdentity', true);
pref('midori.modblur.privacy.blurTabs', false);
pref('midori.modblur.extensions.style', 'compact');
pref('midori.modblur.extensions.columns', 4);
pref('midori.modblur.extensions.iconSize', 22);
pref('midori.modblur.extensions.hideManageButton', false);
pref('midori.modblur.extensions.hideSeparator', false);
pref('midori.modblur.extensions.hideFaded', false);
pref('midori.modblur.icons.mainMenu', true);
pref('midori.modblur.icons.tabsOverview', false);
pref('midori.modblur.icons.midoriMenu', true);
pref('midori.modblur.icons.github', false);
...
pref('midori.modblur.search.textAlignment', 'smart');
pref('midori.modblur.search.compactIdentity', true);
pref('midori.modblur.search.hideExtensionIcon', false);
...
pref('midori.modblur.blur.strength', 'balanced');
pref('midori.modblur.menus.density', 'balanced');
pref('midori.modblur.motion.style', 'calm');
pref('midori.modblur.newtab.hideShortcutTitles', false);
pref('midori.modblur.newtab.centerWidgets', false);
pref('midori.modblur.newtab.centerWidgetsStyle', 'off');
pref('midori.modblur.newtab.circularShortcuts', false);
pref('midori.modblur.newtab.wallpaperBlur', 0);
pref('midori.modblur.theme.spill', false);
pref('midori.modblur.theme.card', false);
pref('midori.modblur.theme.cardStyle', 'off');
pref('midori.modblur.theme.textureStyle', 'off');
