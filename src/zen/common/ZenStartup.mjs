...
// file, You can obtain one at http://mozilla.org/MPL/2.0/.
{
  var gZenStartup = new (class {
    ...
    #checkForWelcomePage() {
      ...
      // Forzar que siempre se muestre el welcome en desarrollo
      // Resetear la preferencia para que siempre se muestre
      //Services.prefs.clearUserPref('zen.welcome-screen.seen');
      
      // Siempre cargar el welcome screen
      //Services.prefs.setStringPref('zen.updates.last-build-id', Services.appinfo.appBuildID);
      //Services.scriptloader.loadSubScript(
      //  'chrome://browser/content/zen-components/ZenWelcome.mjs',
      //  window
