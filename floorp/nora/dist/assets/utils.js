...
const commands = {
  "gecko-open-new-tab": {
    command: () => {
      var _a;
      return (_a = document.getElementById("cmd_newNavigatorTab")) == null ? void 0 : _a.doCommand();
    },
    type: "tab-action"
  },
  "gecko-close-tab": {
    command: () => {
      var _a;
      return (_a = document.getElementById("cmd_close")) == null ? void 0 : _a.doCommand();
    },
    type: "tab-action"
  },
  "gecko-open-new-window": {
    command: () => {
      var _a;
      return (_a = document.getElementById("cmd_newNavigator")) == null ? void 0 : _a.doCommand();
    },
    type: "tab-action"
  },
  ...
  "gecko-close-window": {
    command: () => {
      var _a;
      return (_a = document.getElementById("cmd_closeWindow")) == null ? void 0 : _a.doCommand();
    },
    type: "tab-action"
  },
  ...
  "gecko-print-page": {
    command: () => PrintUtils.startPrintWindow(
      gBrowser.selectedBrowser.browsingContext
    ),
    type: "page-action"
  },
  "gecko-mute-current-tab": {
    command: () => gBrowser.toggleMuteAudioOnMultiSelectedTabs(gBrowser.selectedTab),
    type: "page-action"
  },
  ...
  "gecko-show-page-info": {
    command: (event) => gIdentityHandler.handleMoreInfoClick(event),
    type: "page-action"
  },
  "floorp-rest-mode": {
  ...
  "gecko-back": {
    command: () => {
      var _a;
      return (_a = document.getElementById("Browser:Back")) == null ? void 0 : _a.doCommand();
    },
    type: "history-action"
  },
  "gecko-forward": {
    command: () => {
      var _a;
      return (_a = document.getElementById("Browser:Forward")) == null ? void 0 : _a.doCommand();
    },
    type: "history-action"
  },
  "gecko-stop": {
    command: () => {
      var _a;
      return (_a = document.getElementById("Browser:stop")) == null ? void 0 : _a.doCommand();
    },
    type: "history-action"
  },
  "gecko-reload": {
    command: () => {
      var _a;
      return (_a = document.getElementById("Browser:Reload")) == null ? void 0 : _a.doCommand();
    },
    type: "history-action"
  },
  "gecko-force-reload": {
    command: () => {
      var _a;
      return (_a = document.getElementById("Browser:ReloadSkipCache")) == null ? void 0 : _a.doCommand();
    },
    type: "history-action"
  },
  ...
  "gecko-open-migration-wizard": {
    command: () => MigrationUtils.showMigrationWizard(window, {
  ...
  "floorp-show-pip": {
    command: (event) => gFloorpCSKActionFunctions.PictureInPicture.togglePictureInPicture(
      event
    ),
    type: "pip-action"
  },
  "gecko-bookmark-this-page": {
    command: (event) => BrowserPageActions.doCommandForAction(
  ...
  "gecko-open-bookmark-add-tool": {
    command: () => PlacesUIUtils.showBookmarkPagesDialog(
  ...
  "gecko-toggle-bookmark-toolbar": {
    command: () => BookmarkingUI.toggleBookmarksToolbar("bookmark-tools"),
    type: "bookmark-action"
  },
  ...
  "gecko-open-addons-manager": {
    command: () => {
      var _a;
      return (_a = document.getElementById("Tools:Addons")) == null ? void 0 : _a.doCommand();
    },
    type: "open-page-action"
  },
  ...
  "floorp-open-next-workspace": {
    command: () => gWorkspaces.changeWorkspaceToNextOrBeforeWorkspace(true),
    type: "workspaces-action"
  },
  "floorp-show-bsm": {
    command: () => gBrowserManagerSidebar.controllFunctions.toggleBMSShortcut(),
    type: "bms-action"
  },
  "floorp-show-panel-1": {
  ...
  "floorp-custom-action-1": {
    command: () => gFloorpCustomActionFunctions.evalCustomeActionWithNum(1),
    type: "custom-action"
  },
  "floorp-custom-action-2": {
    command: () => gFloorpCustomActionFunctions.evalCustomeActionWithNum(2),
    type: "custom-action"
  },
  "floorp-custom-action-3": {
    command: () => gFloorpCustomActionFunctions.evalCustomeActionWithNum(3),
    type: "custom-action"
  },
  "floorp-custom-action-4": {
    command: () => gFloorpCustomActionFunctions.evalCustomeActionWithNum(4),
    type: "custom-action"
  },
  "floorp-custom-action-5": {
    command: () => gFloorpCustomActionFunctions.evalCustomeActionWithNum(5),
    type: "custom-action"
  }
};
...
const keyOptions = [
  ...
  // A letter?
  // biome-ignore lint/suspicious/noExplicitAny: <explanation>
  (e) => e.code.toUpperCase(),
  // A letter.
  // biome-ignore lint/suspicious/noExplicitAny: <explanation>
  (e) => trimPrefix(e.code),
  // Digit3, ArrowUp, Numpad9.
  // biome-ignore lint/suspicious/noExplicitAny: <explanation>
  (e) => trimPrefix(e.key),
  // Digit3, ArrowUp, Numpad9.
  // biome-ignore lint/suspicious/noExplicitAny: <explanation>
...
function getShortcutForEvent(e) {
  ...
  return Object.entries(modifierMap).filter(([, isDown]) => isDown).map(([key]) => key).concat(getStringForEvent(e)).join("+");
}
const { ShortcutUtils } = ChromeUtils.importESModule(
  "resource://gre/modules/ShortcutUtils.sys.mjs"
);
function checkIsSystemShortcut(ev) {
