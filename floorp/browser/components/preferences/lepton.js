...
Preferences.addAll([
	...
	{
		id: "userChrome.autohide.toolbar_overlap.allow_layout_shift",
		type: "bool",
	},
...
var gLeptonPane = {
	...
	init() {
		...
		document.getElementById("backtogeneral").addEventListener("command", () => {
			gotoPref("design");
		});
		document
			.getElementById("lepton-design-mode")
			.addEventListener("click", setLeptonUI, false);
		document
			.getElementById("photon-design-mode")
			.addEventListener("click", setPhotonUI, false);
		document
