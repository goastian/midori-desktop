  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DEFAULT_LANGUAGE_TYPE =
          __webpack_require__(1).DEFAULT_LANGUAGE_TYPE;
        ...
        var DatePicker = defineClass(
          /** @lends DatePicker.prototype */ {
            ...
            _changePicker: function (target) {
              ...
              var isDateElement =
                !!selectedBtn.querySelector(SELECTOR_DATE_ICO);
        ...
        var Calendar = defineClass(
          /** @lends Calendar.prototype */ {
            ...
            _initHeader: function (options) {
              var headerContainer =
                this._element.querySelector(HEADER_SELECTOR);
        ...
        var Header = defineClass(
          /** @lends Header.prototype */ {
            ...
            render: function (date, type) {
              ...
              this._container.innerHTML = headerTmpl(context).replace(
                /^\s+|\s+$/g,
                "",
              );
              this._innerElement =
                this._container.querySelector(SELECTOR_INNER_ELEM);
              if (context.showToday) {
                this._infoElement =
                  this._container.querySelector(SELECTOR_INFO_ELEM);
              }
            },
        ...
        var Body = defineClass(
          /** @lends Body.prototype */ {
            ...
            _eachLayer: function (fn) {
              forEachArray(
                [this._dateLayer, this._monthLayer, this._yearLayer],
                fn,
              );
            },
            ...
            _getWeeks: function (year, month) {
              ...
              while (weekNumber < weeksCount) {
                ...
                for (
                  ...
                  dates.push(
                    dateUtil.getDateOfWeek(year, month, weekNumber, i),
                  );
                }
                ...
                if (
                  this.weekStartDay &&
                  !_isFirstWeek(weekNumber, week[0].dayInMonth)
                ) {
        ...
        var DateRangePicker = defineClass(
          /** @lends DateRangePicker.prototype */ {
            ...
            _setTimeRangeOnEndPicker: function () {
              ...
              pickerDate =
                this._endpicker.getDate() || this._startpicker.getDate();
