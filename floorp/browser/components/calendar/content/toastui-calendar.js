...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object")
    ...
    (root["tui"] = root["tui"] || {}),
      (root["tui"]["Calendar"] = factory(root["tui"]["DatePicker"]));
...
*/
      ...
      /***/ 894: /***/ function (__unused_webpack_module, exports) {
      ...
      /***/ 9195: /***/ function (__unused_webpack_module, exports) {
        "use strict";
      ...
      /***/ 1372: /***/ function (
        ...
        var exportWebAssemblyErrorCauseWrapper = function (
          ERROR_NAME,
          wrapper,
        ) {
      ...
      /***/ 4304: /***/ function (
        ...
        module.exports =
          window.DOMPurify ||
          (window.DOMPurify =
            __webpack_require__(5368)["default"] || __webpack_require__(5368));
    ...
    !(function () {
      ...
      function v(n, i, t, o, r) {
        ...
        return (
          null == r &&
            null != preact_module_l.vnode &&
            preact_module_l.vnode(f),
          f
        );
      }
      function y() {
      ...
      function b(n) {
        ((!n.__d && (n.__d = !0) && t.push(n) && !g.__r++) ||
          ...
          ((o = preact_module_l.debounceRendering) || setTimeout)(g);
      }
      function g() {
      ...
      function I(n) {
        this.l[n.type + !1](
          preact_module_l.event ? preact_module_l.event(n) : n,
        );
      }
      function T(n) {
        this.l[n.type + !0](
      ...
      function j(n, u, i, t, o, r, f, e, c) {
        ...
        try {
          n: if ("function" == typeof H) {
            if (
              ...
              null != h.componentWillUpdate &&
                h.componentWillUpdate(g, h.__s, x),
          ...
          (u.__v = null),
            ...
            preact_module_l.__e(n, u, i);
        }
      }
      function z(n, u) {
        preact_module_l.__c && preact_module_l.__c(u, n),
          n.some(function (u) {
            try {
              (n = u.__h),
                (u.__h = []),
      ...
      function L(l, u, i, t, o, r, e, c) {
        ...
        if (null === d) y === p || (c && l.data === p) || (l.data = p);
          ...
          if (
            ...
            (v || h) &&
              ((v &&
                ((h && v.__html == h.__html) || v.__html === l.innerHTML)) ||
      ...
      function N(n, u, i) {
        var t, o;
        if (
          (preact_module_l.unmount && preact_module_l.unmount(n),
      ...
      function P(u, i, t) {
        var o, r, e;
        preact_module_l.__ && preact_module_l.__(u, i),
      ...
      function hooks_module_p(t, r) {
        preact_module_l.__h &&
          preact_module_l.__h(hooks_module_u, t, hooks_module_i || r),
          (hooks_module_i = 0);
        var o =
          hooks_module_u.__H || (hooks_module_u.__H = { __: [], __h: [] });
        return t >= o.__.length && o.__.push({ __V: hooks_module_f }), o.__[t];
      }
      function hooks_module_y(n) {
        return (hooks_module_i = 1), hooks_module_d(hooks_module_z, n);
      }
      function hooks_module_d(n, r, o) {
        var i = hooks_module_p(hooks_module_t++, 2);
        return (
          (i.t = n),
          i.__c ||
            ((i.__ = [
              o ? o(r) : hooks_module_z(void 0, r),
              function (n) {
                var t = i.t(i.__[0], n);
                i.__[0] !== t && ((i.__ = [t, i.__[1]]), i.__c.setState({}));
              },
            ]),
            (i.__c = hooks_module_u)),
          i.__
        );
      }
      function hooks_module_(r, o) {
        ...
        !preact_module_l.__s &&
          hooks_module_w(i.__H, o) &&
          ((i.__ = r), (i.u = o), hooks_module_u.__H.__h.push(i));
      }
      function hooks_module_h(r, o) {
        var i = hooks_module_p(hooks_module_t++, 4);
        !preact_module_l.__s &&
          hooks_module_w(i.__H, o) &&
          ((i.__ = r), (i.u = o), hooks_module_u.__h.push(i));
      }
      ...
      function hooks_module_q(n) {
        var r = hooks_module_u.context[n.__c],
          o = hooks_module_p(hooks_module_t++, 9);
        return (
          (o.c = n),
          r
            ? (null == o.__ && ((o.__ = !0), r.sub(hooks_module_u)),
              r.props.value)
            : n.__
        );
      }
      function hooks_module_x(t, u) {
        preact_module_l.useDebugValue &&
          preact_module_l.useDebugValue(u ? u(t) : t);
      }
      function V(n) {
        var r = hooks_module_p(hooks_module_t++, 10),
          o = hooks_module_y();
        return (
          (r.__ = n),
      ...
      function hooks_module_b() {
        for (var t; (t = hooks_module_c.shift()); )
          if (t.__P)
            try {
              t.__H.__h.forEach(hooks_module_j),
                t.__H.__h.forEach(hooks_module_k),
                (t.__H.__h = []);
            } catch (u) {
              (t.__H.__h = []), preact_module_l.__e(u, t.__v);
            }
      }
      (preact_module_l.__b = function (n) {
        ...
        (preact_module_l.__r = function (n) {
          ...
          o &&
            (hooks_module_r === hooks_module_u
              ...
              : (o.__h.forEach(hooks_module_j),
                o.__h.forEach(hooks_module_k),
                (o.__h = []))),
            (hooks_module_r = hooks_module_u);
        }),
        (preact_module_l.diffed = function (t) {
          ...
          i &&
            i.__H &&
            (i.__H.__h.length &&
              ((1 !== hooks_module_c.push(i) &&
                hooks_module_o === preact_module_l.requestAnimationFrame) ||
                (
                  (hooks_module_o = preact_module_l.requestAnimationFrame) ||
                  function (n) {
                    var t,
                      u = function () {
                        clearTimeout(r),
                          hooks_module_g && cancelAnimationFrame(t),
                          setTimeout(n);
                      },
                      r = setTimeout(u, 100);
        ...
        (preact_module_l.__c = function (t, u) {
          u.some(function (t) {
            try {
      ...
      var es_array_includes = __webpack_require__(9529); // CONCATENATED MODULE: ../../node_modules/immer/dist/immer.esm.mjs
      ...
      function immer_esm_u(n, r) {
        return 2 === immer_esm_o(n)
          ? n.has(r)
      ...
      function immer_esm_f(n, r, t) {
        var e = immer_esm_o(n);
        2 === e ? n.set(r, t) : 3 === e ? (n.delete(r), n.add(t)) : (n[r] = t);
      }
      function immer_esm_c(n, r) {
        return n === r ? 0 !== n || 1 / n == 1 / r : n != n && r != r;
      }
      function immer_esm_s(n) {
        return X && n instanceof Map;
      }
      function immer_esm_v(n) {
        return immer_esm_q && n instanceof Set;
      }
      function immer_esm_p(n) {
        return n.o || n.t;
      }
      function immer_esm_l(n) {
      ...
      function immer_esm_d(n, e) {
        return (
          void 0 === e && (e = !1),
          immer_esm_y(n) || immer_esm_r(n) || !immer_esm_t(n)
            ? n
            : (immer_esm_o(n) > 1 &&
                (n.set = n.add = n.clear = n.delete = immer_esm_h),
              Object.freeze(n),
              e &&
                immer_esm_i(
                  n,
      ...
      function immer_esm_h() {
        immer_esm_n(2);
      }
      function immer_esm_y(n) {
        return null == n || "object" != typeof n || Object.isFrozen(n);
      }
      function immer_esm_b(r) {
        var t = tn[r];
      ...
      function immer_esm_j(n, r) {
        r && (immer_esm_b("Patches"), (n.u = []), (n.s = []), (n.v = r));
      }
      function immer_esm_O(n) {
        immer_esm_g(n), n.p.forEach(immer_esm_S), (n.p = null);
      }
      function immer_esm_g(n) {
        n === U && (U = n.l);
      }
      function immer_esm_w(n) {
      ...
      function immer_esm_P(r, e) {
        e._ = e.p.length;
        var i = e.p[0],
          o = void 0 !== r && r !== i;
        return (
          e.h.g || immer_esm_b("ES5").S(e, r, o),
          o
            ? (i[Q].P && (immer_esm_O(e), immer_esm_n(4)),
              immer_esm_t(r) &&
                ((r = immer_esm_M(e, r)), e.l || immer_esm_x(e, r)),
              e.u && immer_esm_b("Patches").M(i[Q].t, r, e.u, e.s))
            : (r = immer_esm_M(e, i, [])),
          immer_esm_O(e),
          e.u && e.v(e.u, e.s),
          r !== immer_esm_H ? r : void 0
        );
      }
      function immer_esm_M(n, r, t) {
        if (immer_esm_y(r)) return r;
        var e = r[Q];
        if (!e)
          return (
            immer_esm_i(
              r,
              function (i, o) {
                return immer_esm_A(n, e, r, i, o, t);
              },
              !0,
            ),
            r
        ...
        if (e.A !== n) return r;
        if (!e.P) return immer_esm_x(n, e.t, !0), e.t;
        if (!e.I) {
          (e.I = !0), e.A._--;
          var o = 4 === e.i || 5 === e.i ? (e.o = immer_esm_l(e.k)) : e.o;
          immer_esm_i(3 === e.i ? new Set(o) : o, function (r, i) {
            return immer_esm_A(n, e, o, r, i, t);
          }),
            immer_esm_x(n, o, !1),
            t && n.u && immer_esm_b("Patches").R(e, t, n.u, n.s);
        }
        return e.o;
      }
      function immer_esm_A(e, i, o, a, c, s) {
        if ((false && 0, immer_esm_r(c))) {
          var v = immer_esm_M(
            e,
            c,
            s && i && 3 !== i.i && !immer_esm_u(i.D, a) ? s.concat(a) : void 0,
          );
          if ((immer_esm_f(o, a, v), !immer_esm_r(v))) return;
          e.m = !1;
        }
        if (immer_esm_t(c) && !immer_esm_y(c)) {
          if (!e.h.F && e._ < 1) return;
          immer_esm_M(e, c), (i && i.A.l) || immer_esm_x(e, c);
        }
      }
      function immer_esm_x(n, r, t) {
        void 0 === t && (t = !1), n.h.F && n.m && immer_esm_d(r, t);
      }
      function immer_esm_z(n, r) {
        var t = n[Q];
        return (t ? immer_esm_p(t) : n)[r];
      }
      function immer_esm_I(n, r) {
        if (r in n)
      ...
      function E(n) {
        n.o || (n.o = immer_esm_l(n.t));
      }
      function R(n, r, t) {
        var e = immer_esm_s(r)
          ? immer_esm_b("MapSet").N(r, t)
          : immer_esm_v(r)
            ? immer_esm_b("MapSet").T(r, t)
            : n.g
              ? (function (n, r) {
              ...
              : immer_esm_b("ES5").J(r, t);
        return (t ? t.A : immer_esm_()).p.push(e), e;
      }
      function D(e) {
        return (
          immer_esm_r(e) || immer_esm_n(22, e),
          (function n(r) {
            ...
            var e,
              ...
              c = immer_esm_o(r);
            if (u) {
              if (!u.P && (u.i < 4 || !immer_esm_b("ES5").K(u))) return u.t;
              (u.I = !0), (e = immer_esm_F(r, c)), (u.I = !1);
            } else e = immer_esm_F(r, c);
            return (
              immer_esm_i(e, function (r, t) {
                (u && immer_esm_a(u.t, r) === t) || immer_esm_f(e, r, n(t));
              }),
              3 === c ? new Set(e) : e
            );
          })(e)
      ...
      function immer_esm_F(n, r) {
        ...
        return immer_esm_l(n);
      }
      function immer_esm_N() {
        function t(n, r) {
          var t = s[n];
          return (
            t
        ...
        function o(n) {
          for (var r = n.t, t = n.k, e = nn(t), i = e.length - 1; i >= 0; i--) {
            ...
            if (o !== Q) {
              var a = r[o];
              if (void 0 === a && !immer_esm_u(r, o)) return !0;
              var f = t[o],
                s = f && f[Q];
              if (s ? s.t !== a : !immer_esm_c(f, a)) return !0;
            }
          }
          var v = !!r[Q];
        ...
        function f(r) {
          r.O && immer_esm_n(3, JSON.stringify(immer_esm_p(r)));
        }
        var s = {};
        immer_esm_m("ES5", {
          J: function (n, r) {
                    ...
                    if (r && "object" == typeof r) {
                      ...
                      if (t) {
                        var e = t.t,
                          ...
                          c = t.i;
                        if (4 === c)
                          immer_esm_i(o, function (r) {
                            r !== Q &&
                              (void 0 !== e[r] || immer_esm_u(e, r)
                                ? f[r] || n(o[r])
                                : ((f[r] = !0), immer_esm_k(t)));
                          }),
                          ...
                          if (
                            (a(t) && (immer_esm_k(t), (f.length = !0)),
                            o.length < e.length)
                          )
                            for (var s = o.length; s < e.length; s++) f[s] = !1;
                          else
                            for (var v = e.length; v < o.length; v++) f[v] = !0;
                          for (
      ...
      function immer_esm_T() {
        function e(n) {
          ...
          if (immer_esm_v(n)) return new Set(Array.from(n).map(e));
          var r = Object.create(Object.getPrototypeOf(n));
          for (var i in n) r[i] = e(n[i]);
          return (
            immer_esm_u(n, immer_esm_L) && (r[immer_esm_L] = n[immer_esm_L]), r
          );
        }
        function f(n) {
                ...
                for (
                  ...
                  (0 !== v && 1 !== v) ||
                    ...
                    "function" == typeof f &&
                      "prototype" === p &&
                      immer_esm_n(24),
                    "object" != typeof (f = immer_esm_a(f, p)) &&
                      immer_esm_n(15, i.join("/"));
                }
                var l = immer_esm_o(f),
                  d = e(t.value),
                  h = i[i.length - 1];
                ...
                return (function (n, r, t, e) {
                  ...
                  immer_esm_i(n.D, function (n, i) {
                    var v = immer_esm_a(o, n),
                      p = immer_esm_a(s, n),
                      l = i ? (immer_esm_u(o, n) ? "replace" : c) : "remove";
                    if (v !== p || "replace" !== l) {
                      var d = r.concat(n);
                      t.push(
                        "remove" === l
          ...
          f = (function () {
            ...
            return (
              ...
              (o.set = function (n, r) {
                ...
                return (
                  u(t),
                  (immer_esm_p(t).has(n) && immer_esm_p(t).get(n) === r) ||
                    (e(t),
                    immer_esm_k(t),
                    t.D.set(n, !0),
                    t.o.set(n, r),
              ...
              (o.delete = function (n) {
                ...
                return (
                  ...
                  e(r),
                  immer_esm_k(r),
                  r.t.has(n) ? r.D.set(n, !1) : r.D.delete(n),
                  r.o.delete(n),
                  !0
                );
              }),
          ...
          c = (function () {
            ...
            return (
              ...
              (t.add = function (n) {
                var r = this[Q];
                return (
                  u(r), this.has(n) || (o(r), immer_esm_k(r), r.o.add(n)), this
                );
              }),
              (t.delete = function (n) {
                if (!this.has(n)) return !1;
              ...
              (t.clear = function () {
                var n = this[Q];
                u(n),
                  immer_esm_p(n).size && (o(n), immer_esm_k(n), n.o.clear());
              }),
              (t.values = function () {
                var n = this[Q];
      ...
      function J() {
        immer_esm_N(), immer_esm_C(), immer_esm_T();
      }
      function K(n) {
        return n;
      }
      function immer_esm_$(n) {
        return n;
      }
      var G,
        U,
        ...
        immer_esm_q = "undefined" != typeof Set,
        immer_esm_B =
        ...
        immer_esm_H = W
          ...
          : (((G = {})["immer-nothing"] = !0), G),
        immer_esm_L = W ? Symbol.for("immer-draftable") : "__$immer_draftable",
        ...
        en = {
          ...
          set: function (n, r, t) {
            var e = immer_esm_I(immer_esm_p(n), r);
            if (null == e ? void 0 : e.set) return e.set.call(n.k, t), !0;
            if (!n.P) {
              var i = immer_esm_z(immer_esm_p(n), r),
                o = null == i ? void 0 : i[Q];
              if (o && o.t === t) return (n.o[r] = t), (n.D[r] = !1), !0;
              if (immer_esm_c(t, i) && (void 0 !== t || immer_esm_u(n.t, r)))
                return !0;
              E(n), immer_esm_k(n);
            }
            return (
          ...
          deleteProperty: function (n, r) {
            return (
              void 0 !== immer_esm_z(n.t, r) || r in n.t
                ? ((n.D[r] = !1), E(n), immer_esm_k(n))
                : delete n.D[r],
              n.o && delete n.o[r],
              !0
            );
      ...
      var un = (function () {
          function e(r) {
            ...
            (this.g = immer_esm_B),
              ...
              (this.produce = function (r, i, o) {
                ...
                var f;
                if (
                  ("function" != typeof i && immer_esm_n(6),
                  void 0 !== o && "function" != typeof o && immer_esm_n(7),
                  immer_esm_t(r))
                ) {
                  var c = immer_esm_w(e),
                    s = R(e, r, void 0),
                  ...
                  try {
                    ...
                    v ? immer_esm_O(c) : immer_esm_g(c);
                  }
                  return "undefined" != typeof Promise && f instanceof Promise
                    ? f.then(
                        function (n) {
                          return immer_esm_j(c, o), immer_esm_P(n, c);
                        },
                        function (n) {
                          throw (immer_esm_O(c), n);
                        },
                      )
                    : (immer_esm_j(c, o), immer_esm_P(f, c));
                }
                if (!r || "object" != typeof r) {
                  if (
                    (void 0 === (f = i(r)) && (f = r),
                    f === immer_esm_H && (f = void 0),
                    e.F && immer_esm_d(f, !0),
                    o)
                  ) {
                    var p = [],
                      l = [];
                    immer_esm_b("Patches").M(r, f, p, l), o(p, l);
                  }
                  return f;
                }
                immer_esm_n(21, r);
          ...
          return (
            (i.createDraft = function (e) {
              ...
              var i = immer_esm_w(this),
                o = R(this, e, void 0);
              return (o[Q].C = !0), immer_esm_g(i), o;
            }),
            (i.finishDraft = function (r, t) {
              var e = r && r[Q];
              false && 0;
              var i = e.A;
              return immer_esm_j(i, t), immer_esm_P(void 0, i);
            }),
            (i.setAutoFreeze = function (n) {
              this.F = n;
            }),
            (i.setUseProxies = function (r) {
              r && !immer_esm_B && immer_esm_n(20), (this.g = r);
            }),
            (i.applyPatches = function (n, t) {
              ...
              e > -1 && (t = t.slice(e + 1));
              var o = immer_esm_b("Patches").$;
              return immer_esm_r(n)
                ? o(n, t)
        ...
        dn = an.finishDraft.bind(an); /* harmony default export */
      var immer_esm = fn;
      ...
      var range_default = /*#__PURE__*/ __webpack_require__.n(range); // CONCATENATED MODULE: ./src/constants/style.ts
      // common day name
      ...
      var isString = __webpack_require__(758);
      var isString_default = /*#__PURE__*/ __webpack_require__.n(isString); // CONCATENATED MODULE: ./src/helpers/css.ts
      ...
      function extractPercentPx(value) {
        ...
        return {
          ...
          px: pxResult
            ? parseInt("".concat(pxResult[1]).concat(pxResult[2]), 10)
            : 0,
        };
      }
      function getEventColors(uiModel, calendarColor) {
        ...
        return Object.keys(DEFAULT_EVENT_COLORS).reduce((colors, _key) => {
          ...
          colors[key] =
            (_ref =
              (_eventColors$key = eventColors[key]) !== null &&
              _eventColors$key !== void 0
                ? _eventColors$key
                : calendarColor[key]) !== null && _ref !== void 0
              ? _ref
              : DEFAULT_EVENT_COLORS[key];
          return colors;
        }, {});
      }
      // EXTERNAL MODULE: ../../node_modules/core-js/modules/es.error.cause.js
      var es_error_cause = __webpack_require__(1372); // CONCATENATED MODULE: ../../libs/date/src/localDate.js
      ...
      const INVALID_VIEW_TYPE = "Invalid View Type"; // CONCATENATED MODULE: ./src/constants/message.ts
      const MESSAGE_PREFIX = "@toast-ui/calendar: "; // CONCATENATED MODULE: ./src/utils/error.ts
      ...
      class InvalidTimezoneNameError extends Error {
        constructor(timezoneName) {
          super(
            ""
              .concat(MESSAGE_PREFIX)
              .concat(INVALID_TIMEZONE_NAME, " - ")
              .concat(timezoneName),
          );
      ...
      class InvalidDateTimeFormatError extends Error {
        constructor(dateTimeString) {
          super(
            ""
              .concat(MESSAGE_PREFIX)
              .concat(INVALID_DATETIME_FORMAT, " - ")
      ...
      const logger = {
        error: function (firstArg) {
          ...
          console.error(
            "".concat(MESSAGE_PREFIX).concat(firstArg),
            ...restArgs,
          );
        },
      ...
      var isUndefined = __webpack_require__(3929);
      var isUndefined_default = /*#__PURE__*/ __webpack_require__.n(
        isUndefined,
      );
      ...
      var isObject = __webpack_require__(5758);
      var isObject_default = /*#__PURE__*/ __webpack_require__.n(isObject); // CONCATENATED MODULE: ./src/utils/type.ts
      ...
      function calculateTimezoneOffset(timezoneName) {
        ...
        return Math.round(
          (utcDate.getTime() - targetDate.getTime()) / 60 / 1000,
        );
        ...
        return isFunction(
          (_Intl = Intl) === null || _Intl === void 0
            ...
            : (_Intl$DateTimeFormat = _Intl.DateTimeFormat) === null ||
              ...
              ? void 0
              : (_Intl$DateTimeFormat$ = _Intl$DateTimeFormat.prototype) ===
                    null || _Intl$DateTimeFormat$ === void 0
                ? void 0
                : _Intl$DateTimeFormat$.formatToParts,
        );
      }
      ...
      class date_TZDate {
        ...
        getTimezoneOffset() {
          ...
          return (_this$tzOffset = this.tzOffset) !== null &&
            _this$tzOffset !== void 0
            ? _this$tzOffset
        ...
        tz(tzValue) {
          ...
          const tzOffset = isString_default()(tzValue)
            ? calculateTimezoneOffset(tzValue, this)
            : tzValue;
          const newTZDate = new date_TZDate(
            this.getTime() - getTZOffsetMSDifference(tzOffset),
          );
        ...
        local(tzValue) {
          ...
          return new date_TZDate(
            this.getTime() +
              (isPresent(this.tzOffset)
                ? getTZOffsetMSDifference(this.tzOffset)
                : 0),
          );
        }
      ...
      function pick(obj) {
        for (
          var _len = arguments.length,
            propNames = new Array(_len > 1 ? _len - 1 : 0),
            _key = 1;
          _key < _len;
          _key++
        ) {
      ...
      function mergeObject(target) {
        ...
        Object.keys(source).forEach((k) => {
          ...
          if (
            ...
            isObject_default()(target[targetKey]) &&
            isObject_default()(source[sourceKey]) &&
            !(source[sourceKey] instanceof date_TZDate)
          ) {
      ...
      class EventUIModel {
        ...
        collidesWith(uiModel) {
          ...
          [this, uiModel].forEach((event) => {
            const isDuplicateEvent =
              event instanceof EventUIModel && event.duplicateEvents.length > 0;
        ...
        clone() {
          ...
          if (this.renderStarts) {
            clonedEventUIModel.renderStarts = new date_TZDate(
              this.renderStarts,
            );
          }
      ...
      const tokenFunc = {
        ...
        "HH:mm": function (date) {
          ...
          return ""
            .concat(leadingZero(hour, 2), ":")
            .concat(leadingZero(minutes, 2));
        },
        "hh:mm": function (date) {
      ...
      function convMilliseconds(type, value, iteratee) {
        ...
        return [value]
          .concat(convByTimeUnit.slice(index[type]))
          .reduce(iteratee);
      }
      /**
      ...
      function parse(str) {
        ...
        return new date_TZDate().setWithRaw(
          Number(ymd[0]),
      ...
      function getRowStyleInfo(days, narrowWeekend, startDayOfWeek, workweek) {
        ...
        const wideWidth =
          days > limitDaysToApplyNarrowWeekend
            ? 100 / (days - 1)
            : uniformWidth;
        let accumulatedWidth = 0;
        const dates = range_default()(startDayOfWeek, WEEK_DAYS)
          .concat(range_default()(days))
          .slice(0, WEEK_DAYS);
        ...
        return {
          rowStyleInfo,
          cellWidthMap: cellWidthMap.map((widthList) =>
            widthList.map(toPercent),
          ),
        };
      }
      ...
      function getDateDifference(d1, d2) {
        const _d1 = new date_TZDate(
          d1.getFullYear(),
          d1.getMonth(),
          d1.getDate(),
        ).getTime();

        const _d2 = new date_TZDate(
          d2.getFullYear(),
          d2.getMonth(),
          d2.getDate(),
        ).getTime();
      ...
      class EventModel {
        ...
        setTimePeriod(start, end) {
          ...
          this.hasMultiDates =
            this.end.getTime() - this.start.getTime() > MS_PER_DAY;
        }
        /**
      ...
      class Collection {
        ...
        static and() {
          for (
            var _len = arguments.length, filterFns = new Array(_len), _key = 0;
            _key < _len;
            _key++
          ) {
        ...
        getItemID(item) {
          ...
          return (_item$_id =
            item === null || item === void 0 ? void 0 : item._id) !== null &&
            _item$_id !== void 0
            ? _item$_id
            : "";
        }
        ...
        remove() {
          ...
          for (
            var _len4 = arguments.length, items = new Array(_len4), _key4 = 0;
            _key4 < _len4;
            _key4++
          ) {
          ...
          items.forEach((item) => {
            const id =
              isString_default()(item) || isNumber_default()(item)
                ? item
                : this.getItemID(item);
        ...
        get(item) {
          ...
          const id =
            isString_default()(item) || isNumber_default()(item)
              ? item
              : this.getItemID(item);
          return (_this$internalMap$get = this.internalMap.get(id)) !== null &&
            _this$internalMap$get !== void 0
            ? _this$internalMap$get
            : null;
        }
        /**
        ...
        groupBy(groupByFn) {
          ...
          this.internalMap.forEach((item) => {
            ...
            (_result$_key = result[(_key5 = key)]) !== null &&
            _result$_key !== void 0
              ? _result$_key
              : (result[_key5] = new Collection(this.getItemID));
            result[key].add(item);
          });
          return result;
        }
      ...
      function isAllday(event) {
        return (
          event.isAllday ||
          (event.category === "time" &&
            Number(event.end) - Number(event.start) > MS_PER_DAY)
        );
      }
      /**
      ...
      function updateEvent(calendarData, eventId, calendarId, eventData) {
        ...
        const event = calendarData.events.find((item) =>
          isSameEvent(item, eventId, calendarId),
        );
              ...
              immer_esm((state) => {
                ...
                const events = state.calendar.events.toArray().map((event) => {
                  if (event.calendarId === calendarId) {
                    var _colorOptions$color,
                      _colorOptions$backgro,
                      _colorOptions$borderC,
                      _colorOptions$dragBac;

                    event.color =
                      (_colorOptions$color = colorOptions.color) !== null &&
                      _colorOptions$color !== void 0
                        ? _colorOptions$color
                        : event.color;
                    event.backgroundColor =
                      (_colorOptions$backgro = colorOptions.backgroundColor) !==
                        null && _colorOptions$backgro !== void 0
                        ? _colorOptions$backgro
                        : event.backgroundColor;
                    event.borderColor =
                      (_colorOptions$borderC = colorOptions.borderColor) !==
                        null && _colorOptions$borderC !== void 0
                        ? _colorOptions$borderC
                        : event.borderColor;
                    event.dragBackgroundColor =
                      (_colorOptions$dragBac =
                        colorOptions.dragBackgroundColor) !== null &&
                      _colorOptions$dragBac !== void 0
                        ? _colorOptions$dragBac
                        : event.dragBackgroundColor;
                  }
          ...
          setDraggingEventUIModel: (eventUIModel) => {
            set(
              immer_esm((state) => {
                ...
                state.dnd.draggingEventUIModel =
                  (_eventUIModel$clone =
                    eventUIModel === null || eventUIModel === void 0
                      ? void 0
                      : eventUIModel.clone()) !== null &&
                  _eventUIModel$clone !== void 0
                    ? _eventUIModel$clone
                    : null;
              }),
            );
      ...
      const DEFAULT_DUPLICATE_EVENT_CID = -1; // CONCATENATED MODULE: ./src/slices/layout.ts
      ...
      function getRestPanelHeight(dayGridRowsState, lastPanelType, initHeight) {
        return Object.keys(dayGridRowsState).reduce((acc, rowName) => {
          ...
          return (
            acc - dayGridRowsState[rowName].height - DEFAULT_RESIZER_LENGTH
          );
        }, initHeight);
      }
      ...
      function createWeekViewLayoutDispatchers(set) {
        return {
          setLastPanelType: (type) => {
            set(
              immer_esm((state) => {
                ...
                if (type) {
                  state.weekViewLayout.dayGridRows[type].height =
                    getRestPanelHeight(
          ...
          updateLayoutHeight: (height) =>
            set(
              immer_esm((state) => {
                ...
                if (lastPanelType) {
                  state.weekViewLayout.dayGridRows[lastPanelType].height =
                    getRestPanelHeight(
                      state.weekViewLayout.dayGridRows,
                      lastPanelType,
                      height,
          ...
          updateDayGridRowHeightByDiff: (_ref2) => {
            let { rowName, diff } = _ref2;
            return set(
              immer_esm((state) => {
                var _state$weekViewLayout,
                  _state$weekViewLayout2,
                  _state$weekViewLayout3;

                const { lastPanelType } = state.weekViewLayout;
                const height =
                  (_state$weekViewLayout =
                    (_state$weekViewLayout2 =
                      state.weekViewLayout.dayGridRows) === null ||
                    _state$weekViewLayout2 === void 0
                      ? void 0
                      : (_state$weekViewLayout3 =
                            _state$weekViewLayout2[rowName]) === null ||
                          _state$weekViewLayout3 === void 0
                        ? void 0
                        : _state$weekViewLayout3.height) !== null &&
                  _state$weekViewLayout !== void 0
                    ? _state$weekViewLayout
          ...
          setSelectedDuplicateEventCid: (cid) =>
            set(
              immer_esm((state) => {
                state.weekViewLayout.selectedDuplicateEventCid =
                  cid !== null && cid !== void 0
                    ? cid
      ...
      function initializeWeekOptions() {
        ...
        week.collapseDuplicateEvents = initializeCollapseDuplicateEvents(
      ...
      function createOptionsSlice() {
        var _options$defaultView,
          _options$useFormPopup,
          _options$useDetailPop,
          _options$isReadOnly,
          _options$usageStatist,
        ...
        return {
          options: {
            defaultView:
              (_options$defaultView = options.defaultView) !== null &&
              _options$defaultView !== void 0
                ? _options$defaultView
                : "week",
            useFormPopup:
              (_options$useFormPopup = options.useFormPopup) !== null &&
              _options$useFormPopup !== void 0
                ? _options$useFormPopup
                : false,
            useDetailPopup:
              (_options$useDetailPop = options.useDetailPopup) !== null &&
              _options$useDetailPop !== void 0
                ? _options$useDetailPop
                : false,
            isReadOnly:
              (_options$isReadOnly = options.isReadOnly) !== null &&
              _options$isReadOnly !== void 0
                ? _options$isReadOnly
                : false,
            week: initializeWeekOptions(options.week),
            month: initializeMonthOptions(options.month),
            gridSelection: initializeGridSelectionOptions(
              options.gridSelection,
            ),
            usageStatistics:
              (_options$usageStatist = options.usageStatistics) !== null &&
              _options$usageStatist !== void 0
                ? _options$usageStatist
                : true,
            eventFilter:
              (_options$eventFilter = options.eventFilter) !== null &&
              _options$eventFilter !== void 0
                ? _options$eventFilter
                : initialEventFilter,
            ...
            return set(
              immer_esm((state) => {
                ...
                if (newOptions.gridSelection) {
                  newOptions.gridSelection = initializeGridSelectionOptions(
                    newOptions.gridSelection,
                  );
                }

                if (
                  (_newOptions$week = newOptions.week) !== null &&
                  _newOptions$week !== void 0 &&
                  _newOptions$week.collapseDuplicateEvents
                ) {
                  newOptions.week.collapseDuplicateEvents =
                    initializeCollapseDuplicateEvents(
                      newOptions.week.collapseDuplicateEvents,
                    );
                }
      ...
      function createPopupDispatchers(set) {
        return {
          ...
          showDetailPopup: (param, isOpenedInSeeMorePopup) =>
            set(
              immer_esm((state) => {
      ...
      function getSize(el) {
        ...
        if (
          (invalidateSizeValue(w) || invalidateSizeValue(h)) &&
      ...
      const templates = {
        ...
        time(model) {
          ...
          if (start) {
            return h(
              "span",
              null,
              h("strong", null, datetime_toFormat(start, "HH:mm")),
              "\xA0",
              h("span", null, stripTags(title)),
            );
          }
        ...
        timezoneDisplayLabel(_ref) {
          let { displayLabel, timezoneOffset } = _ref;
            ...
            return ""
              ...
              .concat(
                isSameDate(start, end)
                  ? ""
                  : " - ".concat(datetime_toFormat(end, dayFormat)),
              );
          }

          return ""
            .concat(datetime_toFormat(start, detailFormat), " - ")
            .concat(datetime_toFormat(end, endDateFormat));
        },
      ...
      function createStore(storeCreator) {
        ...
        const subscribe = (listener, selector, equalityFn) => {
          ...
          if (selector) {
            ...
            const _equalityFn =
              equalityFn !== null && equalityFn !== void 0
                ? equalityFn
                : Object.is;
      ...
      const { StoreProvider, useStore, useInternalStore } =
        createStoreContext();
      ...
      var browser_default = /*#__PURE__*/ __webpack_require__.n(browser); // CONCATENATED MODULE: ./src/utils/sanitizer.ts
      ...
      function addAttributeHooks() {
        ...
        browser_default().addHook("afterSanitizeAttributes", (node) => {
          if (
            node.tagName === "A" &&
            node.hasAttribute(TEMP_TARGET_ATTRIBUTE)
          ) {
            node.setAttribute(
              "target",
              node.getAttribute(TEMP_TARGET_ATTRIBUTE),
            );
      ...
      function Template(_ref) {
        ...
        let { template, param, as: tagName = "div" } = _ref;
        ...
        return isString_default()(htmlOrVnode)
          ? h(tagName, {
          ...
          : q(htmlOrVnode, {
              className: ""
                .concat(
                  (_htmlOrVnode$props$cl = htmlOrVnode.props.className) !==
                    null && _htmlOrVnode$props$cl !== void 0
                    ? _htmlOrVnode$props$cl
                    : "",
                  " ",
                )
                .concat(cls("template-".concat(template))),
            });
      ...
      const primaryTimezoneSelector = (state) => {
        var _state$options$timezo,
          _state$options,
          _state$options$timezo2,
          _state$options$timezo3,
          _state$options$timezo4;

        return (_state$options$timezo =
          (_state$options = state.options) === null || _state$options === void 0
            ? void 0
            : (_state$options$timezo2 = _state$options.timezone) === null ||
                _state$options$timezo2 === void 0
              ? void 0
              : (_state$options$timezo3 = _state$options$timezo2.zones) ===
                    null || _state$options$timezo3 === void 0
                ? void 0
                : (_state$options$timezo4 = _state$options$timezo3[0]) ===
                      null || _state$options$timezo4 === void 0
                  ? void 0
                  : _state$options$timezo4.timezoneName) !== null &&
          _state$options$timezo !== void 0
          ? _state$options$timezo
          : "Local";
      };
      const customOffsetCalculatorSelector = (state) => {
        var _state$options2, _state$options2$timez;

        return (_state$options2 = state.options) === null ||
          _state$options2 === void 0
          ? void 0
          : (_state$options2$timez = _state$options2.timezone) === null ||
              _state$options2$timez === void 0
            ? void 0
            : _state$options2$timez.customOffsetCalculator;
      };
      const timezonesSelector = (state) => {
        var _state$options$timezo5;

        return (_state$options$timezo5 = state.options.timezone.zones) !==
          null && _state$options$timezo5 !== void 0
          ? _state$options$timezo5
          : [];
      ...
      function getWeekDayNameColor(_ref) {
        ...
        if (isPastDay) {
          ...
          return (_theme$week = theme.week) === null || _theme$week === void 0
            ? void 0
            : _theme$week.pastDay.color;
        }
        ...
        if (isToday) {
          ...
          return (_theme$week2 = theme.week) === null || _theme$week2 === void 0
            ? void 0
            : _theme$week2.today.color;
        }
      ...
      function DayName(_ref3) {
        let { dayName, style, type, theme } = _ref3;
      ...
      const monthGridCellSelector = (theme) => theme.month.gridCell; // CONCATENATED MODULE: ./src/constants/theme.ts
      ...
      const themeStoreCreator = function () {
        ...
        return (set) => {
          return {
            ...createCommonTheme(
              themeOptions === null || themeOptions === void 0
                ? void 0
                : themeOptions.common,
            ),
            ...createWeekTheme(
      ...
      function GridHeader(_ref) {
        ...
        const theme = useTheme(
          type === "month" ? monthDayNameSelector : weekDayNameSelector,
        );
        const {
          backgroundColor = "white",
          borderLeft = null,
          ...
          (_theme$type = theme[type]) === null || _theme$type === void 0
            ? void 0
            : _theme$type.dayName) !== null && _theme$type$dayName !== void 0
          ? _theme$type$dayName
          : {};
      ...
      var es_array_unscopables_flat_map = __webpack_require__(3985); // CONCATENATED MODULE: ./src/constants/grid.ts
      ...
      })(CellBarType || (CellBarType = {})); // CONCATENATED MODULE: ./src/controller/core.ts
      ...
      function getCollisionGroup(events) {
        ...
        events.slice(1).forEach((event, index) => {
          ...
          const found = previousEventList.find((previous) =>
      ...
      function positionUIModels(start, end, matrices, iteratee) {
        const ymdListToRender = makeDateRange(start, end, MS_PER_DAY).map(
          (date) => datetime_toFormat(date, "YYYYMMDD"),
        );
      ...
      function _adjustTimeTopIndex(idsOfDay, uiModelColl) {
        ...
        const sortedTimeEvents = uiModelColl
          .filter(_isNotAllday)
          .sort(array.compare.event.asc);
        const maxIndexInYMD = {};
        sortedTimeEvents.forEach((timeUIModel) => {
          const eventYMD = datetime_toFormat(
            timeUIModel.getStarts(),
            "YYYYMMDD",
          );
          ...
          if (isUndefined_default()(alldayMaxTopInYMD)) {
            alldayMaxTopInYMD = maxIndexInYMD[eventYMD] =
              _getAlldayMaxTopIndexAtYMD(idsOfDay, eventYMD, vAlldayColl);
          }
      ...
      function month_findByDateRange(calendarData, condition) {
        ...
        const { events, idsOfDay } = calendarData;
        const filterFn = Collection.and(
          ...[getEventInDateRangeFilter(start, end)].concat(andFilters),
        );
      ...
      function getUIModelForTimeView(idsOfDay, condition) {
        ...
        const ymdSplitted = splitEventByDateRange(
          idsOfDay,
          start,
          end,
          uiModelTimeColl,
        ...
        const hourStart =
          (_options$hourStart =
            options === null || options === void 0
              ? void 0
              : options.hourStart) !== null && _options$hourStart !== void 0
            ? _options$hourStart
            : 0;
        const hourEnd =
          (_options$hourEnd =
            options === null || options === void 0
              ? void 0
              : options.hourEnd) !== null && _options$hourEnd !== void 0
            ? _options$hourEnd
            : 24;
        const filterFn = Collection.and(
          ...[getEventInDateRangeFilter(start, end)].concat(andFilters),
      ...
      function getExceedCount(uiModel, containerHeight, eventHeight) {
        return uiModel.filter(isExceededHeight(containerHeight, eventHeight))
          .length;
      }

      const getWeekendCount = (row) =>
        row.filter((cell) => isWeekend(cell.getDay())).length;

      function getGridWidthAndLeftPercentValues(
        row,
        narrowWeekend,
        totalWidth,
      ) {
        ...
        const widthPerDay =
          totalWidth /
          (narrowWeekend && !isAllWeekend
            ? gridCellCount * 2 - weekendCount
            : gridCellCount);
        ...
        const leftList = widthList.reduce(
          (acc, _, index) =>
            index ? [...acc, acc[index - 1] + widthList[index - 1]] : [0],
          [],
        );
        return {
          widthList,
      ...
      function getGridDateIndex(date, row) {
        return row.findIndex(
          (cell) => date >= toStartOfDay(cell) && date <= toEndOfDay(cell),
        );
      }
      const getLeftAndWidth = (startIndex, endIndex, row, narrowWeekend) => {
        const { widthList } = getGridWidthAndLeftPercentValues(
          row,
          narrowWeekend,
          TOTAL_WIDTH,
        );
        return {
          ...
          width: getWidth(
            widthList,
            startIndex !== null && startIndex !== void 0 ? startIndex : 0,
            endIndex < 0 ? row.length - 1 : endIndex,
          ),
        };
      };
      const getEventLeftAndWidth = (start, end, row, narrowWeekend) => {
        ...
        return {
          ...
          left: !gridStartIndex
            ? 0
            : getWidth(widthList, 0, gridStartIndex - 1),
        };
      };
      ...
      function getEventUIModelWithPosition(uiModel, row) {
        ...
        const { width, left } = getEventLeftAndWidth(
          modelStart,
          modelEnd,
          row,
          narrowWeekend,
      ...
      function getRenderedEventUIModels(row, calendarData, narrowWeekend) {
        ...
        forEachMatrix3d(eventUIModels, (uiModel) => {
          ...
          idEventModelMap[cid] = getEventUIModelWithPosition(
            uiModel,
            row,
            narrowWeekend,
          );
      ...
      function flattenMatrix3d(matrices) {
        return matrices.flatMap((matrix) =>
          matrix.flatMap((models) => getModels(models)),
        );
      } // TODO: Check it works well when the `narrowWeekend` option is true

      const getTimeGridEventModels = (
        eventMatrix, // NOTE: there are same ui models in different rows. so we need to get unique ui models.
      ) =>
        Array.from(
          new Set(
      ...
      const getWeekViewEvents = (row, calendarData, _ref3) => {
        let { narrowWeekend, hourStart, hourEnd, weekStartDate, weekEndDate } =
          _ref3;
        const panels = [
          {
            name: "milestone",
      ...
      function createDateMatrixOfMonth(renderTargetDate, _ref4) {
        ...
        const baseDate = shouldApplyVisibleWeeksCount
          ? targetDate
          : toStartOfMonth(targetDate);
        const firstDateOfMatrix = subtractDate(
          baseDate,
          baseDate.getDay() -
            startDayOfWeek +
            (baseDate.getDay() < startDayOfWeek ? WEEK_DAYS : 0),
        );
        const dayOfFirstDateOfMatrix = firstDateOfMatrix.getDay();
        const totalDatesCountOfMonth = toEndOfMonth(targetDate).getDate();
        const initialDifference = getDateDifference(
          firstDateOfMatrix,
          baseDate,
        );
        const totalDatesOfMatrix =
          totalDatesCountOfMonth + Math.abs(initialDifference);
        ...
        return range_default()(0, totalWeeksOfMatrix).map((weekIndex) =>
          range_default()(0, WEEK_DAYS).reduce((weekRow, dayOfWeek) => {
      ...
      function getWeekDates(renderDate, _ref5) {
        let { startDayOfWeek = Day.SUN, workweek } = _ref5;
        const now = toStartOfDay(renderDate);
        const nowDay = now.getDay();
        const prevDateCount = nowDay - startDayOfWeek;
        const weekDayList =
          prevDateCount >= 0
            ? range_default()(-prevDateCount, WEEK_DAYS - prevDateCount)
            : range_default()(-WEEK_DAYS - prevDateCount, -prevDateCount);
      ...
      function createTimeGridData(datesOfWeek, options) {
        ...
        const columns = getColumnsData(
          datesOfWeek,
          (_options$narrowWeeken = options.narrowWeekend) !== null &&
            _options$narrowWeeken !== void 0
            ? _options$narrowWeeken
            : false,
        );
        ...
        const rows = range_default()(steps).map((step, index) => {
          ...
          const startTime = ""
            ...
            .padStart(5, "0");
          const endTime = (
            isOdd ? "".concat(hour + 1, ":00") : "".concat(hour, ":30")
          ).padStart(5, "0");
          return {
      ...
      function getRelativeMousePosition(_ref6, _ref7) {
        let { clientX, clientY } = _ref6;
        let { left, top, clientLeft, clientTop } = _ref7;
      ...
      function getIndexFromPosition(arrayLength, maxRange, currentPosition) {
        const calculatedIndex = Math.floor(
          ratio(maxRange, arrayLength, currentPosition),
        );
      ...
      function createGridPositionFinder(_ref8) {
        ...
        const dayRange = range_default()(
          startDayOfWeek,
          startDayOfWeek + columnsCount,
        ).map((day) => day % WEEK_DAYS);
        const narrowColumnCount = narrowWeekend
          ? dayRange.filter((day) => isWeekend(day)).length
          : 0;
        return function gridPositionFinder(mousePosition) {
          ...
          columnWidthList.forEach((width, index) => {
            if (index === 0) {
              ...
              columnLeftList.push(
                columnLeftList[index - 1] + columnWidthList[index - 1],
              );
            }
          });
          const columnIndex = findLastIndex(
            columnLeftList,
      ...
      function GridSelection(_ref) {
        let { type, gridSelectionData, weekDates, narrowWeekend } = _ref;
        const { backgroundColor, border } = useTheme(
          commonGridSelectionSelector,
        );
      ...
      function calculateTimeGridSelectionByCurrentIndex(
        ...
        const { startColumnIndex, endColumnIndex, endRowIndex, startRowIndex } =
          timeGridSelection;
      ...
      function calculateDayGridMonthSelectionByCurrentIndex(
        ...
        if (
          !(
            isPresent(gridSelection) &&
            isPresent(currentIndex) &&
            isPresent(weekLength)
          )
        ) {
          return null;
        }
      ...
      const dayGridMonthSelectionHelper = {
        ...
        getDateFromCollection: (dateCollection, gridSelection) => {
          ...
          return [
            dateMatrix[gridSelection.startRowIndex][
              gridSelection.startColumnIndex
            ],
      ...
      const alldayGridRowSelectionHelper = {
        ...
        getDateFromCollection: (dateCollection, gridSelection) => {
          ...
          return [
            weekDates[gridSelection.startColumnIndex],
            weekDates[gridSelection.endColumnIndex],
          ];
        },
      ...
      function dayGridWeekSelectionSelector(state) {
        return alldayGridRowSelectionHelper.calculateSelection(
          state.gridSelection.dayGridWeek,
        );
      }

      function AlldayGridSelection(_ref) {
        let { weekDates, narrowWeekend } = _ref;
      ...
      function compat_module_g(n, t) {
        function e(n) {
          ...
          return (
            ...
            t ? !t(this.props, n) || !r : compat_module_C(this.props, n)
          );
        }
        function r(t) {
      ...
      ((compat_module_E.prototype = new d()).isPureReactComponent = !0),
        (compat_module_E.prototype.shouldComponentUpdate = function (n, t) {
          return (
            compat_module_C(this.props, n) || compat_module_C(this.state, t)
          );
        });
      ...
      (preact_module_l.unmount = function (n) {
        ...
        ((compat_module_T.prototype = new d()).__c = function (n, t) {
          ...
          var l = function () {
            ...
            f = !0 === t.__h;
          r.__u++ || f || r.setState({ __a: (r.__b = r.__v.__k[0]) }),
            n.then(i, i);
        }),
        ...
        (compat_module_T.prototype.render = function (n, t) {
          ...
          return (
            u && (u.__h = null), [h(p, null, t.__a ? null : n.children), u]
          );
        });
      ...
      ((compat_module_D.prototype = new d()).__a = function (n) {
        var t = this,
        ...
        (compat_module_D.prototype.render = function (n) {
        ...
        (compat_module_D.prototype.componentDidUpdate =
          compat_module_D.prototype.componentDidMount =
            function () {
              var n = this;
      ...
      function compat_module_Z() {}
      function compat_module_Y() {
      ...
      preact_module_l.event = function (n) {
        return (
          ...
          (n.persist = compat_module_Z),
          (n.isPropagationStopped = compat_module_Y),
      ...
      var compat_module_G,
        ...
        compat_module_K = preact_module_l.vnode;
      preact_module_l.vnode = function (n) {
        ...
        if ("string" == typeof t) {
          ...
          "select" == t &&
            ...
            (n.props = r),
            e.class != e.className &&
              ((compat_module_J.enumerable = "className" in e),
              null != e.className && (r.class = e.className),
              Object.defineProperty(r, "className", compat_module_J));
        }
        (n.$$typeof = compat_module_W), compat_module_K && compat_module_K(n);
      };
      var compat_module_Q = preact_module_l.__r;
      preact_module_l.__r = function (n) {
        compat_module_Q && compat_module_Q(n), (compat_module_G = n.__c);
      };
      var compat_module_X = {
          ReactCurrentDispatcher: {
            current: {
              readContext: function (n) {
                return compat_module_G.__n[n.__c].props.value;
              },
            },
          },
        },
        compat_module_nn = "17.0.2";
      function compat_module_tn(n) {
        return h.bind(null, n);
      }
      function compat_module_en(n) {
        return !!n && n.$$typeof === compat_module_W;
      }
      function compat_module_rn(n) {
        return compat_module_en(n) ? q.apply(null, arguments) : n;
      }
      function compat_module_un(n) {
        return !!n.__k && (P(null, n), !0);
      }
      function compat_module_on(n) {
        return (n && (n.base || (1 === n.nodeType && n))) || null;
      }
      var compat_module_ln = function (n, t) {
          return n(t);
        },
      ...
      function compat_module_sn(n) {
        return n;
      }
      function hn() {
        return [!1, compat_module_an];
      }
      var compat_module_vn = hooks_module_h;
      function compat_module_dn(t, r) {
        var u = hooks_module_y(r),
          o = u[0],
          i = u[1];
        return (
          hooks_module_(
      ...
      var compat_module = {
        useState: hooks_module_y,
        useReducer: hooks_module_d,
        useEffect: hooks_module_,
        useLayoutEffect: hooks_module_h,
        useInsertionEffect: hooks_module_h,
        useTransition: hn,
        useDeferredValue: compat_module_sn,
        useSyncExternalStore: compat_module_dn,
        startTransition: compat_module_an,
        ...
        createElement: h,
        createContext: B,
        createFactory: compat_module_tn,
        cloneElement: compat_module_rn,
        createRef: y,
        Fragment: p,
        isValidElement: compat_module_en,
        findDOMNode: compat_module_on,
        Component: d,
        PureComponent: compat_module_E,
        memo: compat_module_g,
        forwardRef: compat_module_R,
        flushSync: compat_module_fn,
        unstable_batchedUpdates: compat_module_ln,
        StrictMode: p,
        Suspense: compat_module_T,
        SuspenseList: compat_module_D,
        lazy: compat_module_U,
        __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: compat_module_X,
      };
      ...
      function ExceedCount(_ref) {
        let { index, exceedCount, isClicked, onClickExceedCount } = _ref;
      ...
      function CollapseButton(_ref2) {
        let { isClicked, isClickedIndex, onClickCollapseButton } = _ref2;
      ...
      function GridCell(_ref3) {
        ...
        const { borderRight, backgroundColor } = useTheme(
          hooks_module_T((theme) => theme.week.dayGrid, []),
        );
        const style = {
          width,
          left,
      ...
      var es_array_unscopables_flat = __webpack_require__(7694); // CONCATENATED MODULE: ./src/components/events/horizontalEventResizeIcon.tsx

      function HorizontalEventResizeIcon(_ref) {
        let { onMouseDown } = _ref;
        return h(
          "span",
          {
            className: ""
              .concat(cls("weekday-resize-handle"), " ")
              .concat(cls("handle-y")),
      ...
      function useCalendarById(calendarId) {
        return useStore(
          hooks_module_T(
            (state) =>
              state.calendar.calendars.find((cal) => cal.id === calendarId),
            [calendarId],
          ),
        );
      ...
      function useCalendarColor(model) {
        ...
        const calendar = useCalendarById(
          (_model$calendarId =
            model === null || model === void 0 ? void 0 : model.calendarId) !==
            null && _model$calendarId !== void 0
            ? _model$calendarId
            : null,
        );
        return F(
      ...
      const MINIMUM_DRAG_MOUSE_DISTANCE = 3; // CONCATENATED MODULE: ./src/hooks/common/useTransientUpdate.ts
      ...
      function useDrag(draggingItemType) {
        let { onInit, onDragStart, onDrag, onMouseUp, onPressESCKey } =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
            : {};
        ...
        const handleMouseDown = hooks_module_T(
          (e) => {
            ...
            onInit === null || onInit === void 0
              ? void 0
              : onInit(e, dndSliceRef.current);
          },
          [onInit, draggingItemType, initDrag],
        );
        const handleMouseMove = hooks_module_T(
          (e) => {
            const {
              initX,
              initY,
        ...
        const handleMouseUp = hooks_module_T(
          (e) => {
            e.stopPropagation();
        ...
        const handleKeyDown = hooks_module_T(
          (e) => {
            if (isKeyPressed(e, KEY.ESCAPE)) {
              setStarted(false);
              cancelDrag();
              onPressESCKey === null || onPressESCKey === void 0
                ? void 0
        ...
        hooks_module_(() => {
          const wrappedHandleMouseMove = (e) => {
            ...
            return (_handleMouseMoveRef$c = handleMouseMoveRef.current) ===
              null || _handleMouseMoveRef$c === void 0
              ? void 0
              : _handleMouseMoveRef$c.call(handleMouseMoveRef, e);
          };

          const wrappedHandleMouseUp = (e) => {
            var _handleMouseUpRef$cur;

            return (_handleMouseUpRef$cur = handleMouseUpRef.current) ===
              null || _handleMouseUpRef$cur === void 0
              ? void 0
              : _handleMouseUpRef$cur.call(handleMouseUpRef, e);
          };

          const wrappedHandleKeyDown = (e) => {
            var _handleKeyDownRef$cur;

            return (_handleKeyDownRef$cur = handleKeyDownRef.current) ===
              null || _handleKeyDownRef$cur === void 0
              ? void 0
              : _handleKeyDownRef$cur.call(handleKeyDownRef, e);
          };
      ...
      function getBorderRadius(exceedLeft, exceedRight) {
        ...
        return ""
          .concat(leftBorderRadius, " ")
          .concat(rightBorderRadius, " ")
          .concat(rightBorderRadius, " ")
          .concat(leftBorderRadius);
      }

      function getEventItemStyle(_ref) {
        let { uiModel, flat, eventHeight, isDraggingTarget, calendarColor } =
          _ref;
        const { exceedLeft, exceedRight } = uiModel;
        const { color, backgroundColor, dragBackgroundColor, borderColor } =
      ...
      function getContainerStyle(_ref2) {
        ...
        const baseStyle = flat
          ...
          : {
              ...
              left: toPercent(
                movingLeft !== null && movingLeft !== void 0
                  ? movingLeft
                  : left,
              ),
      ...
      function HorizontalEvent(_ref4) {
        ...
        const { useDetailPopup, isReadOnly: isReadOnlyCalendar } =
        ...
        const isDraggingGuideEvent =
          isPresent(resizingWidth) || isPresent(movingLeft);
        const isDraggableEvent =
          !isReadOnlyCalendar && !isReadOnly && !isDraggingGuideEvent;

        const startDragEvent = (className) => {
          setDraggingEventUIModel(uiModel);
          layoutContainer === null || layoutContainer === void 0
            ? void 0
        ...
        useTransientUpdate(dndSelector, (_ref5) => {
          let { draggingEventUIModel, draggingState } = _ref5;

          if (
            draggingState === DraggingState.DRAGGING &&
            (draggingEventUIModel === null || draggingEventUIModel === void 0
              ? void 0
        ...
        const onResizeStart = useDrag(
          DRAGGING_TYPE_CREATORS.resizeEvent(
            "dayGrid",
            "".concat(uiModel.cid()),
          ),
          {
        ...
        const onMoveStart = useDrag(
          DRAGGING_TYPE_CREATORS.moveEvent("dayGrid", "".concat(uiModel.cid())),
          {
            onDragStart: () => {
              if (isDraggableEvent) {
                ...
                showDetailPopup(
                  {
                    event: uiModel.model,
                    eventRect:
                      eventContainerRef.current.getBoundingClientRect(),
                  },
                  flat,
                );
              }
        ...
        return h(
          "div",
          {
            ...
            "data-testid": passConditionalProp(
              isDraggableEvent,
              getTestId(uiModel),
            ),
          ...
          h(
            "div",
            {
              ...
              style: {
                ...eventItemStyle,
                backgroundColor: isDotEvent
                  ? null
                  : eventItemStyle.backgroundColor,
      ...
      function useCurrentPointerPositionInGrid(gridPositionFinder) {
        ...
        const clearCurrentGridPos = hooks_module_T(
      ...
      const getTargetEventId = (itemType, area, behavior) => {
        function isEventDraggingType(_itemType) {
          return new RegExp(
            "^event/".concat(area, "/").concat(behavior, "/\\d+$"),
          ).test(_itemType);
        }
      ...
      function useDraggingEvent(area, behavior) {
        ...
        const [isDraggingCanceled, setIsDraggingCanceled] =
          hooks_module_y(false);
        const [draggingEvent, setDraggingEvent] = hooks_module_y(null);
        useTransientUpdate(dndSelector, (_ref) => {
          let { draggingItemType, draggingEventUIModel, draggingState } = _ref;
          const targetEventId = getTargetEventId(
            draggingItemType,
            area,
            behavior,
          );
          const hasMatchingTargetEvent =
            Number(targetEventId) ===
            (draggingEventUIModel === null || draggingEventUIModel === void 0
              ? void 0
              : draggingEventUIModel.cid());
      ...
      function useAlldayGridRowEventMove(_ref) {
        let { rowStyleInfo, gridPositionFinder } = _ref;
        const eventBus = useEventBus();
        const {
          isDraggingEnd,
          isDraggingCanceled,
        ...
        const [currentGridPos, clearCurrentGridPos] =
          useCurrentPointerPositionInGrid(gridPositionFinder);
        const { columnIndex } =
          currentGridPos !== null && currentGridPos !== void 0
            ? currentGridPos
            : {};
        const targetEventStartGridX = F(
          () =>
            type_isNil(movingEvent)
              ? null
              : rowStyleInfo.findIndex((_ref2) => {
                  let { left } = _ref2;
        ...
        const currentMovingLeft = F(() => {
          if (
            type_isNil(columnIndex) ||
            type_isNil(startGridXRef.current) ||
            type_isNil(targetEventStartGridX)
          ) {
            return null;
          }

          const newColumnIndex =
            targetEventStartGridX + columnIndex - startGridXRef.current;
      ...
      function useAlldayGridRowEventResize(_ref) {
        let { weekDates, gridColWidthMap, gridPositionFinder } = _ref;
        const eventBus = useEventBus();
        const {
          isDraggingEnd,
          isDraggingCanceled,
      ...
      function useGridRowHeightController(maxTop, category) {
        ...
        const onClickExceedCount = hooks_module_T(
          (index) => {
      ...
      function useClickPrevention(_ref) {
        let { onClick, onDblClick, delay = 300 } = _ref;
      ...
      function useGridSelection(_ref) {
        ...
        const { useFormPopup, gridSelection: gridSelectionOptions } =
          useStore(optionsSelector);
        const { enableDblClick, enableClick } = gridSelectionOptions;
        const { setGridSelection, addGridSelection, clearAll } =
        ...
        useTransientUpdate(
          hooks_module_T((state) => state.gridSelection[type], [type]),
          (gridSelection) => {
            gridSelectionRef.current = gridSelection;
          },
        );
        useTransientUpdate(dndSelector, (_ref2) => {
          let { draggingState, draggingItemType } = _ref2;
          isSelectingGridRef.current =
            draggingItemType === currentGridSelectionType &&
            draggingState >= DraggingState.INIT;
        });
        const currentGridSelectionType =
          DRAGGING_TYPE_CREATORS.gridSelection(type);
        ...
        const setGridSelectionByPosition = (e) => {
          ...
          if (isPresent(initGridPosition) && isPresent(gridPosition)) {
            setGridSelection(
              type,
              selectionSorter(initGridPosition, gridPosition),
            );
          }
        };

        const [handleClickWithDebounce, handleDblClickPreventingClick] =
          useClickPrevention({
            onClick: (e) => {
              if (enableClick) {
                onMouseUp(e, true);
        ...
        const onMouseUp = (e, isClickEvent) => {
          ...
          if (isPresent(gridSelectionRef.current)) {
            ...
            const gridSelectionSelector = "."
              .concat(cls(GRID_SELECTION_TYPE_MAP[type]), ".")
              .concat(cls("grid-selection"));
            const gridSelectionElements = Array.from(
              (_layoutContainer$quer =
                layoutContainer === null || layoutContainer === void 0
                  ? void 0
                  : layoutContainer.querySelectorAll(gridSelectionSelector)) !==
                null && _layoutContainer$quer !== void 0
                ? _layoutContainer$quer
                : [],
            );
      ...
      function EventDetailSectionDetail(_ref) {
        ...
        let { event } = _ref;
        const { location, recurrenceRule, attendees, state, calendarId, body } =
          event;
        ...
        return h(
          ...
          calendar &&
            h(
              ...
              h("span", {
                ...
                style: {
                  backgroundColor:
                    (_calendar$backgroundC =
                      calendar === null || calendar === void 0
                        ? void 0
                        : calendar.backgroundColor) !== null &&
                    _calendar$backgroundC !== void 0
                      ? _calendar$backgroundC
                      : "",
                },
              }),
              h(
                ...
                (_calendar$name =
                  calendar === null || calendar === void 0
                    ? void 0
                    : calendar.name) !== null && _calendar$name !== void 0
                  ? _calendar$name
                  : "",
              ),
            ),
          body &&
            h(
              ...
              {
                className:
                  eventDetailSectionDetail_classNames.detailItemSeparate,
              },
              h(
                "span",
                {
      ...
      })(FormPopupArrowDirection || (FormPopupArrowDirection = {})); // CONCATENATED MODULE: ./src/contexts/floatingLayer.tsx
      ...
      const useFloatingLayer = (floatingLayerType) => {
        ...
        return (_floatingLayers$float =
          floatingLayers === null || floatingLayers === void 0
            ? void 0
            : floatingLayers[floatingLayerType]) !== null &&
          _floatingLayers$float !== void 0
          ? _floatingLayers$float
          : null;
      ...
      function calculatePopupArrowPosition(eventRect, layoutRect, popupRect) {
        ...
        const isOutOfLayout =
          popupLeft + popupRect.width > layoutRect.left + layoutRect.width;
      ...
      function EventDetailPopup() {
        ...
        const [arrowDirection, setArrowDirection] = hooks_module_y(
          DetailPopupArrowDirection.left,
        );
        ...
        hooks_module_h(() => {
          if (popupContainerRef.current && eventRect && layoutContainer) {
            ...
            const { top: arrowTopPosition, direction } =
        ...
        if (
          type_isNil(event) ||
          type_isNil(eventRect) ||
          type_isNil(detailPopupSlot)
        ) {
          return null;
        }
      ...
      function DropdownMenuItem(_ref) {
        let { index, name, backgroundColor, onClick } = _ref;
        return h(
          "li",
          {
      ...
      function CalendarDropdownMenu(_ref2) {
        let { calendars, setOpened, onChangeIndex } = _ref2;
        ...
        return h(
          ...
          calendars.map((_ref3, index) => {
            let { name, backgroundColor = "000" } = _ref3;
      ...
      function PopupSection(_ref) {
        let { children, classNames = [], onClick = noop } = _ref;
        return h(
          "div",
          {
      ...
      function CalendarSelector(_ref) {
        let { calendars, selectedCalendarId, formStateDispatch } = _ref;
        const { isOpened, setOpened, toggleDropdown } = useDropdownState();
        const selectedCalendar = calendars.find(
          (calendar) => calendar.id === selectedCalendarId,
        );
        const { backgroundColor = "", name = "" } =
          selectedCalendar !== null && selectedCalendar !== void 0
            ? selectedCalendar
            : {};
      ...
      var external_commonjs_tui_date_picker_commonjs2_tui_date_picker_import_tui_date_picker_amd_tui_date_picker_root_tui_DatePicker_ =
        __webpack_require__(4268);
      var external_commonjs_tui_date_picker_commonjs2_tui_date_picker_import_tui_date_picker_amd_tui_date_picker_root_tui_DatePicker_default =
        /*#__PURE__*/ __webpack_require__.n(
          external_commonjs_tui_date_picker_commonjs2_tui_date_picker_import_tui_date_picker_amd_tui_date_picker_root_tui_DatePicker_,
        ); // CONCATENATED MODULE: ./src/hooks/template/useStringOnlyTemplate.ts

      function useStringOnlyTemplate(_ref) {
        let { template, model, defaultValue = "" } = _ref;
        const templates = useStore(templateSelector);
        const templateFunc = templates[template];
      ...
      const DateSelector = compat_module_R(function DateSelector(_ref, ref) {
        let { start, end, isAllday = false, formStateDispatch } = _ref;
        ...
        hooks_module_(() => {
          if (
            ...
            ref.current =
              external_commonjs_tui_date_picker_commonjs2_tui_date_picker_import_tui_date_picker_amd_tui_date_picker_root_tui_DatePicker_default().createRangePicker(
                {
                  startpicker: {
      ...
      function StateDropdownMenu(_ref) {
        let { setOpened, setEventState } = _ref;
      ...
      function EventStateSelector(_ref) {
        let { eventState = "Busy", formStateDispatch } = _ref;
        const { isOpened, setOpened, toggleDropdown } = useDropdownState();

        const handleChangeEventState = (state) =>
          formStateDispatch({
      ...
      function LocationInputBox(_ref) {
        let { location, formStateDispatch } = _ref;
      ...
      function TitleInputBox(_ref) {
        let { title, isPrivate = false, formStateDispatch } = _ref;
      ...
      function eventFormPopup_calculatePopupPosition(
        popupArrowPointPosition,
        layoutRect,
        popupRect,
      ) {
        let top =
          popupArrowPointPosition.top -
          popupRect.height -
      ...
      function EventFormPopup() {
        ...
        const [formState, formStateDispatch] = useFormState(
          (_calendars$ = calendars[0]) === null || _calendars$ === void 0
            ? void 0
            : _calendars$.id,
        );
        ...
        hooks_module_h(() => {
          if (
            ...
            const layoutRect = layoutContainer.getBoundingClientRect();
            const popupRect = popupContainerRef.current.getBoundingClientRect();
            const { top, left, direction } =
              eventFormPopup_calculatePopupPosition(
                popupArrowPointPosition,
                layoutRect,
                popupRect,
              );
        ...
        const onSubmit = (e) => {
          ...
          eventData.start = new date_TZDate(
            (_datePickerRef$curren = datePickerRef.current) === null ||
              _datePickerRef$curren === void 0
              ? void 0
              : _datePickerRef$curren.getStartDate(),
          );
          eventData.end = new date_TZDate(
            (_datePickerRef$curren2 = datePickerRef.current) === null ||
              _datePickerRef$curren2 === void 0
              ? void 0
              : _datePickerRef$curren2.getEndDate(),
          );
          ...
          h(
            ...
            h(
              ...
              h(
                ...
                calendars !== null && calendars !== void 0 && calendars.length
                  ? h(CalendarSelector, {
      ...
      function PopupOverlay() {
        ...
        const onClick = (ev) => {
          ...
          ev.stopPropagation();
          shownPopupParam === null || shownPopupParam === void 0
            ? void 0
            : (_shownPopupParam$clos = shownPopupParam.close) === null ||
                _shownPopupParam$clos === void 0
              ? void 0
              : _shownPopupParam$clos.call(shownPopupParam);
          hideAllPopup();
        };
      ...
      function SeeMoreEventsPopup() {
        ...
        const isHidden =
          type_isNil(date) ||
          type_isNil(popupPosition) ||
          type_isNil(seeMorePopupSlot);
        hooks_module_(() => {
      ...
      function Layout(_ref) {
        ...
        const { setLastPanelType, updateLayoutHeight } =
          useDispatch("weekViewLayout");
        const layoutClassName = F(
          () => "".concat(cls("layout"), " ").concat(className),
          [className],
        );
        hooks_module_h(() => {
          if (container) {
            const onResizeWindow = () =>
              updateLayoutHeight(container.offsetHeight);
        ...
        hooks_module_h(() => {
          if (container && autoAdjustPanels) {
            ...
            if (
              !isString_default()(lastChild) &&
              !isNumber_default()(lastChild) &&
              !type_isNil(lastChild)
            ) {
        ...
        return h(
          ...
          h(EventFormPopup, null),
          h(EventDetailPopup, null),
          h(SeeMoreEventsPopup, null),
          h(PopupOverlay, null),
        );
      ...
      function PanelResizer(_ref) {
        let { name, height } = _ref;
        const border = useTheme(
          hooks_module_T((theme) => theme.week.panelResizer.border, []),
        );
      ...
      const Panel = compat_module_R(function Panel(_ref2, ref) {
        ...
        const { height: dayGridRowHeight } = useStore(
          hooks_module_T(
            (state) => {
              ...
              return (_state$weekViewLayout =
                state.weekViewLayout.dayGridRows[name]) !== null &&
                _state$weekViewLayout !== void 0
                ? _state$weekViewLayout
                : {};
            },
        ...
        const height =
          dayGridRowHeight !== null && dayGridRowHeight !== void 0
            ? dayGridRowHeight
            : initialHeight;
        hooks_module_h(() => {
          updateDayGridRowHeight({
      ...
      const addTimeGridPrefix = (selector) =>
        "".concat(className, "-").concat(selector);
      const timeFormats = {
        second: "HH:mm:ss",
        minute: "HH:mm",
        hour: "HH:mm",
      ...
      function getMarginLeft(left) {
        const { percent, px } = extractPercentPx("".concat(left));
        return left > 0 || percent > 0 || px > 0
      ...
      function getStyles(_ref) {
        ...
        const { color, backgroundColor, borderColor, dragBackgroundColor } =
          getEventColors(uiModel, calendarColor);
        const containerStyle = {
          width: getContainerWidth(duplicateWidth || width, marginLeft),
          height: "calc("
            .concat(toPercent(Math.max(height, minHeight)), " - ")
            .concat(defaultMarginBottom, "px)"),
          top: toPercent(top),
      ...
      function TimeEvent(_ref3) {
        ...
        useTransientUpdate(dndSelector, (_ref4) => {
          let { draggingEventUIModel, draggingState } = _ref4;
        ...
        const onMoveStart = useDrag(
          DRAGGING_TYPE_CREATORS.moveEvent(
            "timeGrid",
            "".concat(uiModel.cid()),
          ),
          {
        ...
        return h(
          ...
          {
            "data-testid": ""
              .concat(isGuide ? "guide-" : "", "time-event-")
              .concat(model.title, "-")
              .concat(uiModel.cid()),
            "data-calendar-id": calendarId,
            "data-event-id": id,
      ...
      function gridSelectionByColumn_GridSelection(_ref) {
        let { top, height, text } = _ref;
        const { backgroundColor, border } = useTheme(
          hooks_module_T((theme) => theme.common.gridSelection, []),
        );
        const color = useTheme(
          hooks_module_T((theme) => theme.week.gridSelection.color, []),
        );
        const style = {
          top: toPercent(top),
        ...
        return h(
          "div",
          {
            ...
            style: style,
            "data-testid": "time-grid-selection-"
              .concat(top, "-")
              .concat(height),
          },
          text.length > 0
      ...
      function GridSelectionByColumn(_ref2) {
        let { columnIndex, timeGridRows } = _ref2;
        ...
        const gridSelectionProps = F(() => {
          ...
          const { top: startRowTop, startTime: startRowStartTime } =
      ...
      function useTimeGridEventResize(_ref) {
        let { gridPositionFinder, totalUIModels, columnIndex, timeGridData } =
          _ref;
        const eventBus = useEventBus();
        const {
          isDraggingEnd,
        ...
        const baseResizingInfo = F(() => {
          ...
          const resizeTargetUIModelColumns = totalUIModels.map((uiModels) =>
            uiModels.filter(
          ...
          const findRowIndexOf = (targetDate, targetColumnIndex) => (row) => {
            const rowStartTZDate = setTimeStrToDate(
              columns[targetColumnIndex].date,
              row.startTime,
            );
          ...
          const eventStartDateColumnIndex =
            resizeTargetUIModelColumns.findIndex((row) => row.length > 0);
          const resizingStartEventUIModel =
            resizeTargetUIModelColumns[eventStartDateColumnIndex][0];
          const { goingDuration = 0 } = resizingStartEventUIModel.model;
          const renderStart = addMinutes(
            resizingStartEventUIModel.getStarts(),
            -goingDuration,
          );
          const eventStartDateRowIndex = Math.max(
            rows.findIndex(
              findRowIndexOf(renderStart, eventStartDateColumnIndex),
            ),
            0,
          ...
          const resizingEndEventUIModel =
            resizeTargetUIModelColumns[eventEndDateColumnIndex][0];
          const { comingDuration = 0 } = resizingEndEventUIModel.model;
          const renderEnd = addMinutes(
            resizingEndEventUIModel.getStarts(),
            comingDuration,
          );
          let eventEndDateRowIndex = rows.findIndex(
            findRowIndexOf(renderEnd, eventEndDateColumnIndex),
          ); // when it is -1, the event ends after the current view.

          eventEndDateRowIndex =
            eventEndDateRowIndex >= 0 ? eventEndDateRowIndex : rows.length - 1;
          return {
        ...
        hooks_module_(() => {
          if (canCalculateGuideUIModel) {
            ...
            if (
              ...
              const { height, goingDurationHeight, comingDurationHeight } =
                clonedUIModel;
              ...
              const newGoingDurationHeight =
                (goingDurationHeight * height) / newHeight;
              const newComingDurationHeight =
                (comingDurationHeight * height) / newHeight;
              clonedUIModel.setUIProps({
                height: newHeight,
                goingDurationHeight: newGoingDurationHeight,
                comingDurationHeight: newComingDurationHeight,
                modelDurationHeight:
                  100 - (newGoingDurationHeight + newComingDurationHeight),
              });
        ...
        hooks_module_(() => {
          if (canCalculateGuideUIModel) {
            ...
            if (
              (columnIndex === eventStartDateColumnIndex ||
                columnIndex === eventEndDateColumnIndex) &&
              eventStartDateColumnIndex !== eventEndDateColumnIndex
            ) {
              let clonedUIModel;
              ...
              if (columnIndex === eventStartDateColumnIndex) {
                // first column
                clonedUIModel =
                  resizeTargetUIModelColumns[columnIndex][0].clone();
              } else {
                // last column
      ...
      function VerticalEvents(_ref) {
        let { eventUIModels, minEventHeight } = _ref;
        ...
        return h(
          ...
          eventUIModels.map((eventUIModel) =>
            h(TimeEvent, {
              key: ""
                .concat(eventUIModel.valueOf(), "-")
                .concat(eventUIModel.cid()),
              uiModel: eventUIModel,
      ...
      const Column = compat_module_g(function Column(_ref3) {
        ...
        const borderRight = useTheme(
          hooks_module_T((theme) => theme.week.timeGrid.borderRight, []),
        );
      ...
      const GridLines = compat_module_g(function GridLines(_ref) {
        let { timeGridRows } = _ref;
        const { halfHourLineBorder, hourLineBorder } = useTheme(
          gridLineBorderSelector,
        );
        return h(
          "div",
          {
      ...
      function getMovingEventPosition(_ref) {
        ...
        const startIndex = Math.max(
          getCurrentIndexByTime(nextStart, hourStart),
          0,
        );
        const endIndex = Math.min(
          getCurrentIndexByTime(nextEnd, hourStart),
        ...
        const height = isEndAtNextDate
          ? maxHeight
          : Math.max(indexDiff, 1) * rowHeight;
        return {
          top,
          height,
        };
      ...
      function useTimeGridEventMove(_ref2) {
        let { gridPositionFinder, timeGridData } = _ref2;
        ...
        const gridDiff = F(() => {
          if (
            type_isNil(initGridPosRef.current) ||
            type_isNil(currentGridPos)
          ) {
            return null;
          }
          ...
          return {
            columnDiff:
              currentGridPos.columnIndex - initGridPosRef.current.columnIndex,
        ...
        const nextStartTime = F(() => {
          ...
          return addMilliseconds(
            startDateTime,
            gridDiff.rowDiff * MS_PER_THIRTY_MINUTES +
              gridDiff.columnDiff * MS_PER_DAY,
          );
        }, [gridDiff, startDateTime]);
        const movingEvent = F(() => {
          if (
            type_isNil(draggingEvent) ||
            type_isNil(currentGridPos) ||
            type_isNil(gridDiff)
          ) {
            return null;
      ...
      function movingEventShadow_MovingEventShadow(_ref) {
        let { gridPositionFinder, timeGridData } = _ref;
      ...
      function NowIndicator(_ref) {
        let { top, columnWidth, columnCount, columnIndex } = _ref;
              ...
              (_layoutContainer$quer =
                layoutContainer === null || layoutContainer === void 0
                  ...
                  : layoutContainer.querySelector(
                      ".".concat(cls("panel"), ".").concat(cls("time")),
                    )) !== null && _layoutContainer$quer !== void 0
                ? _layoutContainer$quer
                : null;
      ...
      function NowIndicatorLabel(_ref) {
        let { unit, top, now, zonedNow } = _ref;
        const color = useTheme(
          hooks_module_T((theme) => theme.week.nowIndicatorLabel.color, []),
        );
        ...
        return h(
          ...
          dateDifference !== 0 &&
            h(
              ...
              "["
                .concat(dateDifference > 0 ? "+" : "-")
                .concat(Math.abs(dateDifference), "]"),
            ),
          h(Template, {
      ...
      const monthVisibleEventCountSelector = (state) => {
        ...
        return (_state$options$month$ =
          state.options.month.visibleEventCount) !== null &&
          _state$options$month$ !== void 0
          ? _state$options$month$
          : 6;
      };
      const showNowIndicatorOptionSelector = (state) =>
        state.options.week.showNowIndicator;
      const showTimezoneCollapseButtonOptionSelector = (state) => {
        var _state$options$week$s;

        return (_state$options$week$s =
          state.options.week.showTimezoneCollapseButton) !== null &&
          _state$options$week$s !== void 0
          ? _state$options$week$s
          : false;
      };
      const timezonesCollapsedOptionSelector = (state) => {
        var _state$options$week$t;

        return (_state$options$week$t =
          state.options.week.timezonesCollapsed) !== null &&
          _state$options$week$t !== void 0
          ? _state$options$week$t
          : false;
      ...
      function HourRows(_ref) {
        ...
        let { rowsInfo, isPrimary, borderRight, width, nowIndicatorState } =
          _ref;
        ...
        const zonedNow = isPresent(nowIndicatorState)
          ? addMinutes(
              nowIndicatorState.now,
              (_rowsInfo$0$diffFromP = rowsInfo[0].diffFromPrimaryTimezone) !==
                null && _rowsInfo$0$diffFromP !== void 0
                ? _rowsInfo$0$diffFromP
                : 0,
            )
          : null;
      ...
      const TimeColumn = compat_module_g(function TimeColumn(_ref3) {
        let { timeGridRows, nowIndicatorState } = _ref3;
        const showNowIndicator = useStore(showNowIndicatorOptionSelector);
        ...
        const rowsByHour = F(
          () =>
            timeGridRows.filter(
              (_, index) =>
                index % 2 === 0 || index === timeGridRows.length - 1,
            ),
          [timeGridRows],
        );
        const hourRowsPropsMapper = hooks_module_T(
          (row, index, diffFromPrimaryTimezone) => {
            const shouldHideRow = (_ref4) => {
              let { top: rowTop, height: rowHeight } = _ref4;
              ...
              return (
                rowTop - rowHeight <= indicatorTop &&
                indicatorTop <= rowTop + rowHeight
              );
            };
            ...
            let date = setTimeStrToDate(
              new date_TZDate(),
              isLast ? row.endTime : row.startTime,
            );
        ...
        const hourRowsWidth =
          otherTimezones.length > 0 ? 100 / (otherTimezones.length + 1) : 100;
        ...
        const otherTimezoneHourRowsProps = F(() => {
          ...
          return otherTimezones.reverse().map((timezone) => {
            ...
            const primaryTimezoneOffset = tzConverter(
              primaryTimezone.timezoneName,
            ).getTimezoneOffset();
            const currentTimezoneOffset =
              tzConverter(timezoneName).getTimezoneOffset();
            const diffFromPrimaryTimezone =
              currentTimezoneOffset - primaryTimezoneOffset;
      ...
      function getTopPercentByTime(date, start, end) {
        ...
        const time =
          math_limit(date.getTime(), [startTime], [endTime]) - startTime;
      ...
      function setCroppedEdges(uiModel, options) {
        const { goingStart, comingEnd, startColumnTime, endColumnTime } =
          options;
      ...
      function getDuplicateLeft(uiModel, baseLeft) {
        ...
        if (prevEvent) {
          ...
          const { percent: leftPercent, px: leftPx } = extractPercentPx(
            "".concat(prevEvent.duplicateLeft),
          );
          const { percent: widthPercent, px: widthPx } = extractPercentPx(
            "".concat(prevEvent.duplicateWidth),
          );
          ...
          if (percent !== 0) {
            left = "calc("
              .concat(toPercent(percent), " ")
              .concat(px > 0 ? "+" : "-", " ")
              .concat(toPx(Math.abs(px)), ")");
          } else {
            left = toPx(px);
          }
        } else {
      ...
      function getDuplicateWidth(uiModel, baseWidth) {
        const { collapse } = uiModel; // if it is collapsed, (COLLAPSED_DUPLICATE_EVENT_WIDTH_PX)px
        // if it is expanded, (baseWidth)% - (other duplicate events' width + marginLeft)px - (its marginLeft)px

        return collapse
          ? "".concat(COLLAPSED_DUPLICATE_EVENT_WIDTH_PX, "px")
          : "calc("
              .concat(toPercent(baseWidth), " - ")
              .concat(
                toPx(
      ...
      function setDimension(uiModel, options) {
        ...
        if (duplicateEvents.length > 0) {
          ...
          dimension.duplicateWidth = getDuplicateWidth(
            uiModel,
            dimension.width,
          );
        }
      ...
      function setDuplicateEvents(
        ...
        const eventObjects = uiModels.map((uiModel) =>
          uiModel.model.toEventObject(),
        );
        uiModels.forEach((targetUIModel) => {
          if (
            targetUIModel.collapse ||
            targetUIModel.duplicateEvents.length > 0
          ) {
            return;
          }

          const duplicateEvents = getDuplicateEvents(
            targetUIModel.model.toEventObject(),
            eventObjects,
          );
          ...
          const duplicateEventUIModels = duplicateEvents.map((event) =>
            uiModels.find((uiModel) => uiModel.cid() === event.__cid),
          );
          const isSelectedGroup = !!(
            selectedDuplicateEventCid > DEFAULT_DUPLICATE_EVENT_CID &&
            duplicateEvents.find(
              (event) => event.__cid === selectedDuplicateEventCid,
            )
          );
          const duplicateStarts = duplicateEvents.reduce((acc, _ref2) => {
            let { start, goingDuration } = _ref2;
      ...
      function setRenderInfoOfUIModels(
        ...
        const uiModels = events
          .filter(isTimeEvent)
          .filter(column_isBetween(startColumnTime, endColumnTime))
          .sort(array.compare.event.asc);
        ...
        const usingTravelTime = true;
        const collisionGroups = getCollisionGroup(
          expandedEvents,
          usingTravelTime,
        );
        const matrices = getMatrices(
      ...
      function TimeGrid(_ref) {
          ...
          () =>
            columns
              .map((_ref2) => {
                ...
                return events
                  .filter(
                    column_isBetween(toStartOfDay(date), toEndOfDay(date)),
        ...
        hooks_module_h(() => {
          if (isMounted()) {
            ...
            if (
              ((_currentDateData$curr =
                currentDateData === null || currentDateData === void 0
                  ? void 0
                  : currentDateData.currentDateIndex) !== null &&
              _currentDateData$curr !== void 0
                ? _currentDateData$curr
                : -1) >= 0
            ) {
        ...
        useInterval(
          updateTimeGridIndicator,
          isPresent(currentDateData) ? MS_PER_MINUTES : null,
        );
        return h(
          "div",
          {
      ...
      function TimezoneCollapseButton(_ref) {
        ...
        return h(
          "button",
          {
            ...
            onClick: () =>
              eventBus.fire("clickTimezonesCollapseBtn", isCollapsed),
          },
          h("span", {
      ...
      function TimezoneLabel(_ref) {
        let { label, offset, tooltip, width = 100, left } = _ref;
        return h(
          "div",
          {
            title: tooltip,
      ...
      function TimezoneLabels(_ref2) {
        ...
        const tzConverter = useTZConverter();
        const { showTimezoneCollapseButton, timezonesCollapsed } =
        ...
        const timezoneLabelProps = timezones.map((_ref3) => {
          let { displayLabel, timezoneName, tooltip } = _ref3;
                ...
                _extends(
                  {
                    key: "subTimezone-".concat(
                      (_subTimezone$label = subTimezone.label) !== null &&
                        _subTimezone$label !== void 0
                        ? _subTimezone$label
                        : subTimezone.offset,
                    ),
      ...
      const DEFAULT_EVENT_PANEL = ["allday", "time"]; // CONCATENATED MODULE: ./src/helpers/view.ts
      ...
      function useEventsWithTimezone(events) {
        ...
        return F(() => {
          ...
          timedEvents.each((eventModel) => {
            ...
            let zonedStart = tzConverter(
              primaryTimezoneName,
              clonedEventModel.start,
            );
            let zonedEnd = tzConverter(
              primaryTimezoneName,
              clonedEventModel.end,
      ...
      function useCalendarData(calendar) {
        for (
          var _len = arguments.length,
            filters = new Array(_len > 1 ? _len - 1 : 0),
            _key = 1;
          _key < _len;
          _key++
        ) {
        ...
        const filteredEvents = F(
          () => calendar.events.filter(Collection.and(...filters)),
          [calendar.events, filters],
        );
        const filteredEventsWithTimezone =
          useEventsWithTimezone(filteredEvents);
        return F(
          () => ({ ...calendar, events: filteredEventsWithTimezone }),
      ...
      function isTimeGridDraggingType(draggingItemType) {
        return /^(event|gridSelection)\/timeGrid/.test(
          draggingItemType !== null && draggingItemType !== void 0
            ? draggingItemType
            : "",
        );
      }
      ...
      function useTimeGridScrollSync(scrollArea, rowCount) {
        useTransientUpdate(dndSelector, (_ref) => {
          let { y, draggingItemType, draggingState } = _ref;
          ...
          if (
            ...
            const { offsetTop, offsetHeight, scrollHeight } = scrollArea; // Set minimum scroll boundary to the height of one row.
      ...
      function timegridHeightSelector(state) {
        ...
        return (_state$weekViewLayout = state.weekViewLayout) === null ||
          _state$weekViewLayout === void 0
          ? void 0
          : (_state$weekViewLayout2 = _state$weekViewLayout.dayGridRows) ===
                null || _state$weekViewLayout2 === void 0
            ? void 0
            : (_state$weekViewLayout3 = _state$weekViewLayout2.time) === null ||
                _state$weekViewLayout3 === void 0
              ? void 0
              : _state$weekViewLayout3.height;
      }
      ...
      function useDayViewState() {
        ...
        const { dayGridRows: gridRowLayout, lastPanelType } = useStore(
      ...
      function day_Day() {
        ...
        const { calendar, options, gridRowLayout, lastPanelType, renderDate } =
          useDayViewState();
        const primaryTimezoneName = useStore(primaryTimezoneSelector);
        const gridHeaderMarginLeft = useTheme(
          hooks_module_T((theme) => theme.week.dayGridLeft.width, []),
        );
        ...
        const dayNames = getDayNames(
          days,
          (_options$week$dayName =
            (_options$week = options.week) === null || _options$week === void 0
              ? void 0
              : _options$week.dayNames) !== null &&
            _options$week$dayName !== void 0
            ? _options$week$dayName
            : [],
        );
        ...
        const dayGridEvents = F(() => {
          const getFilterRange = () => {
            ...
            return [
              toStartOfDay(addDate(days[0], -1)),
              toEndOfDay(addDate(days[0], 1)),
            ];
          };
          ...
          return h(
            ...
            rowType === "allday"
              ? h(AlldayGridRow, {
                  ...
                  weekDates: days,
                  height:
                    (_gridRowLayout$rowTyp = gridRowLayout[rowType]) === null ||
                    _gridRowLayout$rowTyp === void 0
                      ? void 0
                      : _gridRowLayout$rowTyp.height,
                  options: weekOptions,
                })
              : h(OtherGridRow, {
                  category: rowType,
                  ...
                  weekDates: days,
                  height:
                    (_gridRowLayout$rowTyp2 = gridRowLayout[rowType]) ===
                      null || _gridRowLayout$rowTyp2 === void 0
                      ? void 0
                      : _gridRowLayout$rowTyp2.height,
                  options: weekOptions,
                  gridColWidthMap: cellWidthMap,
                }),
          );
      ...
      function AccumulatedGridSelection(_ref) {
        let { rowIndex, weekDates, narrowWeekend } = _ref;
        const gridSelectionDataByRow = useStore(
          hooks_module_T(
            (state) =>
              state.gridSelection.accumulated.dayGridMonth.map(
                (gridSelection) =>
      ...
      function MoreEventsButton(_ref) {
        let { type, number, onClickButton, className } = _ref;
        const { reset } = useDispatch("dnd"); // prevent unexpected grid selection when clicking on the button
        ...
        const exceedButtonTemplate = "monthGrid".concat(
      ...
      function getDateColor(_ref) {
        let { date, theme, renderDate, isToday } = _ref;
      ...
      function getSeeMorePopupSize(_ref) {
        let { grid, offsetWidth, eventLength, layerSize } = _ref;
      ...
      function getSeeMorePopupRect(_ref2) {
        let { layoutContainer, cell, popupSize } = _ref2;
        const containerRect = layoutContainer.getBoundingClientRect();
        const cellRect = cell.getBoundingClientRect();
        const popupPosition = getSeeMorePopupPosition(
          popupSize,
          containerRect,
          cellRect,
        );
      ...
      function usePopupPosition(eventLength, parentContainer, layoutContainer) {
        const { width: moreViewWidth, height: moreViewHeight } = useTheme(
          monthMoreViewSelector,
        );
        const [container, containerRefCallback] = useDOMNode();
      ...
      function gridCell_GridCell(_ref3) {
        ...
        return h(
          "div",
          {
            ...
            style: {
              ...style,
              backgroundColor: isWeekend(date.getDay())
                ? backgroundColor
                : "inherit",
            },
            ref: containerRefCallback,
      ...
      const GridRow = compat_module_g(function GridRow(_ref) {
        ...
        const [container, containerRefCallback] = useDOMNode();
        const border = useTheme(
          hooks_module_T((theme) => theme.common.border, []),
        );
        return h(
          "div",
          {
      ...
      function GridSelectionByRow(_ref) {
        let { weekDates, narrowWeekend, rowIndex } = _ref;
        const gridSelectionDataByRow = useStore(
          hooks_module_T(
            (state) =>
              dayGridMonthSelectionHelper.calculateSelection(
        ...
        const dayEvents = events
          ...
          .map((uiModel) =>
            h(HorizontalEvent, {
              ...
              headerHeight:
                headerHeight !== null && headerHeight !== void 0
                  ? headerHeight
      ...
      function useDayGridMonthEventMove(_ref) {
        let { dateMatrix, rowInfo, gridPositionFinder, rowIndex } = _ref;
        const eventBus = useEventBus();
        const {
          isDraggingEnd,
          isDraggingCanceled,
        ...
        const movingEventUIModel = F(() => {
          ...
          if (
            ...
            (currentGridPos === null || currentGridPos === void 0
              ? void 0
              : currentGridPos.rowIndex) === rowIndex
          ) {
            var _currentGridPos$colum, _currentGridPos$colum2;

            shadowEventUIModel = movingEvent;
            shadowEventUIModel.left =
              rowInfo[
                (_currentGridPos$colum =
                  currentGridPos === null || currentGridPos === void 0
                    ? void 0
                    : currentGridPos.columnIndex) !== null &&
                _currentGridPos$colum !== void 0
                  ? _currentGridPos$colum
                  : 0
              ].left;
            shadowEventUIModel.width =
              rowInfo[
                (_currentGridPos$colum2 =
                  currentGridPos === null || currentGridPos === void 0
                    ? void 0
                    : currentGridPos.columnIndex) !== null &&
                _currentGridPos$colum2 !== void 0
                  ? _currentGridPos$colum2
                  : 0
              ].width;
          }
        ...
        useWhen(() => {
          ...
          if (shouldUpdate) {
            ...
            const currentDate =
              dateMatrix[currentGridPos.rowIndex][currentGridPos.columnIndex];
            const timeOffsetPerDay =
              getDateDifference(currentDate, preStartDate) * MS_PER_DAY;
            const newStartDate = new date_TZDate(
              preStartDate.getTime() + timeOffsetPerDay,
            );
            const newEndDate = new date_TZDate(
              newStartDate.getTime() + eventDuration,
            );
            eventBus.fire("beforeUpdateEvent", {
      ...
      function dayGridMonth_movingEventShadow_MovingEventShadow(_ref) {
        let { dateMatrix, gridPositionFinder, rowInfo, rowIndex } = _ref;
      ...
      function getRowPosOfUIModel(uiModel, dateRow) {
        const startColumnIndex = Math.max(
          getGridDateIndex(uiModel.getStarts(), dateRow),
          0,
        );
      ...
      function useDayGridMonthEventResize(_ref) {
        ...
        const baseResizingInfo = F(() => {
          ...
          const resizeTargetUIModelRows = renderedUIModels.map((_ref2) => {
            let { uiModels } = _ref2;
            return uiModels.filter(
              (uiModel) => uiModel.cid() === resizingStartUIModel.cid(),
            );
          });
          const eventStartDateRowIndex = resizeTargetUIModelRows.findIndex(
            (row) => row.length > 0,
          );
          const eventEndDateRowIndex = findLastIndex(
        ...
        const canCalculateProps =
          isPresent(baseResizingInfo) &&
          isPresent(resizingStartUIModel) &&
          isPresent(currentGridPos); // Calculate the first row of the dragging event
        ...
        hooks_module_(() => {
          if (
            ...
            const { eventStartDateRowIndex, eventStartDateColumnIndex } =
              baseResizingInfo;
            const clonedUIModel =
              baseResizingInfo.resizeTargetUIModelRows[
                eventStartDateRowIndex
              ][0].clone();
            let height;
        ...
        hooks_module_(() => {
          if (
            ...
            setGuideProps([
              clonedUIModel,
              cellWidthMap[0][currentGridPos.columnIndex],
            ]);
          }
        }, [
          baseResizingInfo,
        ...
        useWhen(() => {
          if (canCalculateProps) {
             ...
             */
            const { eventStartDateColumnIndex, eventStartDateRowIndex } =
              baseResizingInfo;
            const shouldUpdate =
              !isDraggingCanceled &&
      ...
      function useCellContentAreaHeight(eventHeight) {
        ...
        const [cellContentAreaHeight, setCellContentAreaHeight] =
          hooks_module_y(0);
        hooks_module_(() => {
          if (ref.current) {
            ...
            const headerHeight =
              ...
              (themeHeaderHeight !== null && themeHeaderHeight !== void 0
                ? themeHeaderHeight
                : MONTH_CELL_BAR_HEIGHT);
            const footerHeight =
              themeFooterHeight !== null && themeFooterHeight !== void 0
                ? themeFooterHeight
                : 0;
            const baseContentAreaHeight =
              rowHeight - headerHeight - footerHeight;
            const visibleEventCountHeight =
              visibleEventCount * (eventHeight + MONTH_EVENT_MARGIN_TOP);
            setCellContentAreaHeight(
              Math.min(baseContentAreaHeight, visibleEventCountHeight),
            );
          }
        }, [
          themeFooterHeight,
      ...
      function DayGridMonth(_ref) {
        let { dateMatrix = [], rowInfo = [], cellWidthMap = [] } = _ref;
        ...
        const { ref, cellContentAreaHeight } =
        ...
        const renderedEventUIModels = F(
          () =>
            dateMatrix.map((week) =>
              getRenderedEventUIModels(week, calendarData, narrowWeekend),
            ),
        ...
        return h(
          ...
          dateMatrix.map((week, rowIndex) => {
            const { uiModels, gridDateEventModelMap } =
      ...
      function getMonthDayNames(options) {
        ...
        const dayIndices = [...Array(7)].map(
          (_, i) => (startDayOfWeek + i) % 7,
        );
        const monthDayNames = dayIndices.map((i) => ({
          day: i,
          label: capitalize(dayNames[i]),
        }));
        return monthDayNames.filter((dayNameInfo) =>
          workweek ? !isWeekend(dayNameInfo.day) : true,
        );
      }
      ...
      function Month() {
        ...
        const { rowStyleInfo, cellWidthMap } = F(
          () =>
            getRowStyleInfo(
              dayNames.length,
              narrowWeekend,
      ...
      function Week() {
        ...
        const { options, calendar, gridRowLayout, lastPanelType, renderDate } =
          useWeekViewState();
        const gridHeaderMarginLeft = useTheme(
          hooks_module_T((theme) => theme.week.dayGridLeft.width, []),
        );
        ...
        const eventByPanel = F(() => {
          const getFilterRange = () => {
            if (primaryTimezoneName === "Local") {
              return [
                toStartOfDay(first(weekDates)),
                toEndOfDay(last(weekDates)),
              ];
            } // NOTE: Extend filter range because of timezone offset differences

            return [
              toStartOfDay(addDate(first(weekDates), -1)),
              toEndOfDay(addDate(last(weekDates), 1)),
            ];
          };
      ...
      var dist_a = function (e, t) {
          return String(e).replace(/(\n+)/g, "$1" + (t || "\t"));
        },
        dist_i = function (e, t, r) {
          return (
          ...
          null != o &&
            ...
            (t +=
              "-" == n[0]
                ? n
                : dist_l[n] ||
                  (dist_l[n] = n.replace(/([A-Z])/g, "-$1").toLowerCase())),
            (t += ": "),
            (t += o),
            "number" == typeof o && !1 === dist_r.test(n) && (t += "px"),
            (t += ";"));
        }
        return t || void 0;
      }
      ...
      var dist_g = function (e, t) {
          return dist_m(e, t, dist_c);
        },
        dist_h = [];
      function dist_m(t, r, n) {
        (r = r || {}), (n = n || {});
        var o = preact_module_l.__s;
        preact_module_l.__s = !0;
        var a = dist_x(t, r, n);
        return (
          preact_module_l.__c && preact_module_l.__c(t, dist_h),
          (dist_h.length = 0),
          (preact_module_l.__s = o),
          a
        );
      }
      function dist_x(r, n, l, c, g, h) {
        if (null == r || "boolean" == typeof r) return "";
        if ("object" != typeof r) return dist_o(r);
        var m = l.pretty,
          y = m && "string" == typeof m ? m : "\t";
        if (Array.isArray(r)) {
          for (var b = "", S = 0; S < r.length; S++)
            m && S > 0 && (b += "\n"), (b += dist_x(r[S], n, l, c, g, h));
          return b;
        }
        var k,
          w = r.type,
        ...
        if ("function" == typeof w) {
          if (((C = !0), !l.shallow || (!c && !1 !== l.renderRootComponent))) {
            if (w === p) {
              var A = [];
              return (
                dist_u(A, r.props.children),
                dist_x(A, n, l, !1 !== l.shallowHighOrder, g, h)
              );
            }
            var H,
              j = (r.__c = {
            ...
            if (w.prototype && "function" == typeof w.prototype.render) {
              ...
              ((j = r.__c = new w(O, $)).__v = r),
                ...
                (j.context = $),
                w.getDerivedStateFromProps
                  ? (j.state = dist_f(
                      dist_f({}, j.state),
                      w.getDerivedStateFromProps(j.props, j.state),
                    ))
            ...
            return (
              j.getChildContext &&
                (n = dist_f(dist_f({}, n), j.getChildContext())),
              preact_module_l.diffed && preact_module_l.diffed(r),
              dist_x(H, n, l, !1 !== l.shallowHighOrder, g, h)
            );
          }
          w =
            (k = w).displayName ||
            ...
            (function (e) {
              ...
              if (!t) {
                for (var r = -1, n = dist_p.length; n--; )
                  if (dist_p[n] === e) {
                    r = n;
                    break;
                  }
                r < 0 && (r = dist_p.push(e) - 1), (t = "UnnamedComponent" + r);
              }
              return t;
            })(k);
        }
          ...
          for (var q = 0; q < W.length; q++) {
            ...
            if ("children" !== z) {
              if (
                ...
                "style" === z && I && "object" == typeof I && (I = dist_s(I)),
                  "a" === z[0] &&
                    "r" === z[1] &&
                    "boolean" == typeof I &&
                    (I = String(I));
                ...
                else if ("textarea" === w && "value" === z) P = I;
        ...
        if (((U += ">"), dist_d.test(w)))
          throw new Error(w + " is not a valid HTML tag name in " + U);
        var B,
          G = dist_.test(w) || (l.voidElements && l.voidElements.test(w)),
          J = [];
        if (R) m && dist_i(R) && (R = "\n" + y + dist_a(R, y)), (U += R);
        else if (null != P && dist_u((B = []), P).length) {
          for (
            var K = m && ~U.indexOf("\n"), Q = !1, X = 0;
            X < B.length;
            X++
            ...
            if (null != Y && !1 !== Y) {
              var ee = dist_x(
                ...
                l,
                !0,
                "svg" === w || ("foreignObject" !== w && g),
                h,
              );
              if ((m && !K && dist_i(ee) && (K = !0), ee))
                if (m) {
      ...
      var customEvents_default = /*#__PURE__*/ __webpack_require__.n(
        customEvents,
      ...
      class CalendarCore {
        ...
        constructor(container) {
          ...
          this.container = isString_default()(container)
            ? (_document$querySelect =
                (_document = document) === null || _document === void 0
                  ? void 0
                  : _document.querySelector(container)) !== null &&
        ...
        calculateWeekRenderDate(_ref2) {
          let { renderDate, offset, weekOptions } = _ref2;
        ...
        getEventModel(eventId, calendarId) {
          ...
          return events.find((_ref4) => {
            let { id, calendarId: eventCalendarId } = _ref4;
        ...
        getEvent(eventId, calendarId) {
          ...
          return (_this$getEventModel$t =
            (_this$getEventModel = this.getEventModel(eventId, calendarId)) ===
              null || _this$getEventModel === void 0
              ? void 0
              : _this$getEventModel.toEventObject()) !== null &&
            _this$getEventModel$t !== void 0
            ? _this$getEventModel$t
            : null;
        }
        /**
         * Update an event.
        ...
        getElement(eventId, calendarId) {
          ...
          if (event && this.container) {
            return this.container.querySelector(
              '[data-event-id="'
                .concat(eventId, '"][data-calendar-id="')
                .concat(calendarId, '"]'),
            );
          }
