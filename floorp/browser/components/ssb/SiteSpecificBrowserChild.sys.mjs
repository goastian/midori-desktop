...
const { SiteSpecificBrowserBase } = ChromeUtils.importESModule(
  "chrome://floorp/content/modules/ssb/SiteSpecificBrowserService.mjs",
);
...
class WebBrowserChrome {
   ...
   *                                 app tab.
   * @returns {string} the target to use for the load.
   */
   ...
   * @returns {boolean} whether the load should proceed or not.
   */
  shouldLoadURI(
    docShell,
    uri,
