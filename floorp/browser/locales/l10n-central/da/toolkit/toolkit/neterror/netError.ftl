...
neterror-dns-not-found-trr-third-party-warning = Du kan forsætte med en DNS-resolver, der ikke er sikker. Men ved at gøre det kan tredjeparter måske se, hvilke websteder du besøger.
