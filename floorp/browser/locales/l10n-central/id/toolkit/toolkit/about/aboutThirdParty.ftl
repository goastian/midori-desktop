...
third-party-requires-restart = { -brand-short-name } harus dimulai ulang untuk mengubah modul pihak ketiga yang diblokir.
third-party-should-restart-title = Mulai Ulang { -brand-short-name }
third-party-should-restart-ok = Mulai ulang { -brand-short-name } sekarang
