...
settings-pp-not-wanted = Προειδοποίηση! Έχετε αποφασίσει να μην χρησιμοποιήσετε κύριο κωδικό πρόσβασης. Δεν θα προστατεύονται οι αποθηκευμένοι κωδικοί πρόσβασης και τα ιδιωτικά κλειδιά πιστοποιητικών που διαχειρίζεται το { -brand-short-name }.
