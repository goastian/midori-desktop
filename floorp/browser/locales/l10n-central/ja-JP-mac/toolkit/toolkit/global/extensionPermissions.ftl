...
webext-perms-description-browsingData = 最近のブラウジング履歴、Cookie および関連データの消去
...
webext-perms-description-declarativeNetRequestFeedback = ブラウジング履歴の読み取り
...
webext-perms-description-history = ブラウジング履歴へのアクセス
...
webext-perms-description-topSites = ブラウジング履歴へのアクセス
